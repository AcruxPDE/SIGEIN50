...
namespace SIGE.AccesoDatos.Implementaciones.EvaluacionOrganizacional
{
    ...
    public class ConfiguracionOperaciones
    {
        ...
        public List<SPE_OBTIENE_EMPLEADOS_Result> ObtieneEmpleados(XElement pXmlSeleccion = null,bool? pFgFoto = null, string pCL_USUARIO = null, bool? pFgActivo = null, int? pIdEmpresa = null)
        {
            using (context = new SistemaSigeinEntities())
            {
                ...
                return context.SPE_OBTIENE_EMPLEADOS(vXmlFiltro, pCL_USUARIO, pFgActivo, pFgFoto, pIdEmpresa).ToList();
            }
        }
