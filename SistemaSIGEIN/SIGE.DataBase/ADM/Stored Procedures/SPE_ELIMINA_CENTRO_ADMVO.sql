...
-- Description: Elimina un registro de la tabla C_CENTRO_ADMVO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_CENTRO_ADMVO]
...
DELETE FROM ADM.C_CENTRO_ADMVO WHERE ID_CENTRO_ADMVO = @PIN_ID_CENTRO_ADMVO

       SET @XML_RESULTADO = DBO.F_ERROR_CREAR_ENCABEZADO( @@ROWCOUNT, 1, 'SUCCESSFUL')
SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó el centro administrativo satisfactoriamente', 'ES')
SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó el centro administrativo satisfactoriamente', 'EN')
