...
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_AREA_INTERES]
	@XML_RESULTADO XML OUT,      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
	@PIN_ID_AREA_INTERES AS int,
	@PIN_CL_AREA_INTERES AS nvarchar(20),
...
BEGIN
	...
	BEGIN TRY		   			
		...
		DELETE FROM ADM.C_AREA_INTERES
		WHERE [ID_AREA_INTERES] = @PIN_ID_AREA_INTERES
