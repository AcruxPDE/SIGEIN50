...
-- Description: Elimina un C_CAMPO_ADICIONAL
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_CAMPO_ADICIONAL]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_CAMPO_ADICIONAL
		DELETE FROM ADM.C_CAMPO_ADICIONAL
