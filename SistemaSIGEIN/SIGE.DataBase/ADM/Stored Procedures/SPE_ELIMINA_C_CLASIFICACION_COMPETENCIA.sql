...
-- Description: Elimina un registro de la tabla C_CLASIFICACION_COMPETENCIA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_CLASIFICACION_COMPETENCIA]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_CLASIFICACION_COMPETENCIA
		DELETE FROM ADM.C_CLASIFICACION_COMPETENCIA
	    ...
	    SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó la clasificación de competencia satisfactoriamente', 'ES')
		SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó la clasificación de competencia satisfactoriamente', 'EN')
