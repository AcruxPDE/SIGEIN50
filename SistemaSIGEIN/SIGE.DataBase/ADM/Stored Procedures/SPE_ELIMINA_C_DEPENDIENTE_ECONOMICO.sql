...
-- Description: Elimina un C_DEPENDIENTE_ECONOMICO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_DEPENDIENTE_ECONOMICO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_DEPENDIENTE_ECONOMICO
		DELETE FROM ADM.C_DEPENDIENTE_ECONOMICO
