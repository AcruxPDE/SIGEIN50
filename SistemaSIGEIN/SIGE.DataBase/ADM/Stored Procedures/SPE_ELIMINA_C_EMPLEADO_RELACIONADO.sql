...
-- Description: Elimina un registro de la tabla C_EMPLEADO_RELACIONADO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_EMPLEADO_RELACIONADO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_EMPLEADO_RELACIONADO
		DELETE FROM ADM.C_EMPLEADO_RELACIONADO
