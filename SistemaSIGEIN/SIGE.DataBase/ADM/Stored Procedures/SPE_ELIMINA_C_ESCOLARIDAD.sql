...
-- Description: Elimina un C_ESCOLARIDAD
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_ESCOLARIDAD]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_ESCOLARIDAD
		DELETE FROM ADM.C_ESCOLARIDAD
		WHERE [ID_ESCOLARIDAD] = @PIN_ID_ESCOLARIDAD
				

		SET @XML_RESULTADO = DBO.F_ERROR_CREAR_ENCABEZADO( @@ROWCOUNT, 1, 'SUCCESSFUL')
		SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó la escolaridad satisfactoriamente', 'ES')
		SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó la escolaridad satisfactoriamente', 'EN')
