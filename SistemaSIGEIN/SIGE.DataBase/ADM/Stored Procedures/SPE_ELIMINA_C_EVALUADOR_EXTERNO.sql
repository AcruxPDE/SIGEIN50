...
-- Description: Elimina un C_EVALUADOR_EXTERNO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_EVALUADOR_EXTERNO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_EVALUADOR_EXTERNO
		DELETE FROM ADM.C_EVALUADOR_EXTERNO
