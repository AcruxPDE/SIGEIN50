...
-- Description: Elimina un registro de la tabla C_GRUPO_PREGUNTA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_GRUPO_PREGUNTA]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_GRUPO_PREGUNTA
		DELETE FROM ADM.C_GRUPO_PREGUNTA
