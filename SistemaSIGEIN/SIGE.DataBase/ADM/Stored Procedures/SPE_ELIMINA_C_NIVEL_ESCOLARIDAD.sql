...
-- Description: Elimina un C_NIVEL_ESCOLARIDAD
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_NIVEL_ESCOLARIDAD]
...
BEGIN
	...
	DECLARE @IBV INT 
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_NIVEL_ESCOLARIDAD
		DELETE FROM ADM.C_NIVEL_ESCOLARIDAD
		...
		SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó el nivel de escolaridad satisfactoriamente', 'ES')
		SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó el nivel de escolaridad satisfactoriamente', 'EN')
