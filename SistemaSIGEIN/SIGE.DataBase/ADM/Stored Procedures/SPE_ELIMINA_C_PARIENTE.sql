...
-- Description: Elimina un registro de la tabla C_PARIENTE
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_PARIENTE]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_PARIENTE
		DELETE FROM ADM.C_PARIENTE
