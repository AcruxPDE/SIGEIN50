...
-- Description: Elimina un registro de la tabla C_PREGUNTA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_PREGUNTA]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_PREGUNTA
		DELETE FROM ADM.C_PREGUNTA
