...
-- Description: Elimina un registro de la tabla C_PUESTO_RELACIONADO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_PUESTO_RELACIONADO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_PUESTO_RELACIONADO
		DELETE FROM ADM.C_PUESTO_RELACIONADO
		WHERE [ID_PUESTO_RELACIONADO] = @PIN_ID_PUESTO_RELACIONADO
