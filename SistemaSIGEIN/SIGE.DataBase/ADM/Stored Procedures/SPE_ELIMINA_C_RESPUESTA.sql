...
-- Description: Elimina un registro de la tabla C_RESPUESTA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_RESPUESTA]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_RESPUESTA
		DELETE FROM ADM.C_RESPUESTA
