...
-- Description: Elimina un C_SECUENCIA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_C_SECUENCIA]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.C_SECUENCIA
		DELETE FROM ADM.C_SECUENCIA
