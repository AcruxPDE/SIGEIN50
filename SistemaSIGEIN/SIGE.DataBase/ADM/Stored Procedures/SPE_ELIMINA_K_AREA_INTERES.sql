...
-- Description: Elimina un registro de la tabla K_AREA_INTERES
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_K_AREA_INTERES]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.K_AREA_INTERES
		DELETE FROM ADM.K_AREA_INTERES
