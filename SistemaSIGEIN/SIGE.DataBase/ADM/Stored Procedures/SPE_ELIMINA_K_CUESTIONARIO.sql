...
-- Description: Elimina un registro de la tabla K_CUESTIONARIO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_K_CUESTIONARIO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.K_CUESTIONARIO
		DELETE FROM ADM.K_CUESTIONARIO
