...
-- Description: Elimina un registro de la tabla K_CUESTIONARIO_PREGUNTA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_K_CUESTIONARIO_PREGUNTA]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.K_CUESTIONARIO_PREGUNTA
		DELETE FROM ADM.K_CUESTIONARIO_PREGUNTA
		WHERE [ID_CUESTIONARIO_PREGUNTA] = @PIN_ID_CUESTIONARIO_PREGUNTA
