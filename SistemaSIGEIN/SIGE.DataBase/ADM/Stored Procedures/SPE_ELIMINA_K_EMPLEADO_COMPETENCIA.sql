...
-- Description: Elimina un registro de la tabla K_EMPLEADO_COMPETENCIA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_K_EMPLEADO_COMPETENCIA]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.K_EMPLEADO_COMPETENCIA
		DELETE FROM ADM.K_EMPLEADO_COMPETENCIA
