...
-- Description: Elimina un registro de la tabla K_EVALUADO_EVALUADOR
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_K_EVALUADO_EVALUADOR]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.K_EVALUADO_EVALUADOR
		DELETE FROM ADM.K_EVALUADO_EVALUADOR
