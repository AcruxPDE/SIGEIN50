...
-- Description: Elimina un registro de la tabla K_EVALUADO_PERIODO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_K_EVALUADO_PERIODO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.K_EVALUADO_PERIODO
		DELETE FROM ADM.K_EVALUADO_PERIODO
		WHERE [ID_EVALUADOR_PERIODO] = @PIN_ID_EVALUADOR_PERIODO
