...
-- Description: Elimina un registro de la tabla K_REQUISICION
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_K_REQUISICION]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.K_REQUISICION
		DELETE FROM ADM.K_REQUISICION
		WHERE [ID_REQUISICION] = @PIN_ID_REQUISICION
				


		SET @XML_RESULTADO = DBO.F_ERROR_CREAR_ENCABEZADO( @@ROWCOUNT, 1, 'SUCCESSFUL')
		SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó la requisición satisfactoriamente', 'ES')
		SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó la requisición satisfactoriamente', 'EN')
