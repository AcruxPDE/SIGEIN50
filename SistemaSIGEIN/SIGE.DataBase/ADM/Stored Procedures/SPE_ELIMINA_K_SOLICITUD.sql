...
-- Description: Elimina un registro de la tabla K_SOLICITUD
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_K_SOLICITUD]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.K_SOLICITUD
		DELETE FROM ADM.K_SOLICITUD
