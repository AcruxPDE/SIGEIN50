...
-- Description: Elimina un M_DEPARTAMENTO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_M_DEPARTAMENTO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.M_DEPARTAMENTO
		DELETE FROM ADM.M_DEPARTAMENTO
