...
-- Description: Elimina un M_EMPLEADO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_M_EMPLEADO]
	@XML_RESULTADO XML OUT,      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
	@PIN_ID_EMPLEADO AS int, @PIN_CL_EMPLEADO AS nvarchar(20), 
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.M_EMPLEADO
		DELETE FROM ADM.M_EMPLEADO
		WHERE [ID_EMPLEADO] = @PIN_ID_EMPLEADO AND
