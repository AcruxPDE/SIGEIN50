...
-- Description: Elimina un registro de la tabla S_CONFIGURACION
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_S_CONFIGURACION]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.S_CONFIGURACION
		DELETE FROM ADM.S_CONFIGURACION
--		WHERE 
