...
-- Description: Elimina un S_TIPO_DATO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_S_TIPO_DATO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.S_TIPO_DATO
		DELETE FROM ADM.S_TIPO_DATO
		WHERE CL_TIPO_DATO = @PIN_CL_TIPO_DATO AND NB_TIPO_DATO = @PIN_NB_TIPO_DATO
