...
-- Description: Elimina un registro de la tabla S_TIPO_RELACION_PUESTO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_S_TIPO_RELACION_PUESTO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.S_TIPO_RELACION_PUESTO
		DELETE FROM ADM.S_TIPO_RELACION_PUESTO
