...
-- Description: Elimina un registro de la tabla VW_PARENTEZCO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_ELIMINA_VW_PARENTEZCO]
	@XML_RESULTADO XML OUT,      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
	@PIN_NB_PARENTEZCO AS NVARCHAR(20),
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  ADM.VW_PARENTEZCO
		DELETE FROM ADM.VW_PARENTEZCO
