...
-- CRETAE date: 29/12/2015
-- Description: Inserta un nuevo registro en la tabla C_CENTRO_OPTVO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_CENTRO_OPTVO] 
      ...
      ,@PIN_CL_CENTRO_OPTVO AS nvarchar(10)
      ,@PIN_NB_CENTRO_OPTVO AS nvarchar(100)
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
			...
			INSERT INTO ADM.C_CENTRO_OPTVO
					   ([ID_CENTRO_OPTVO]
						,[CL_CLIENTE]
						,[CL_CENTRO_OPTVO]
						,[NB_CENTRO_OPTVO]
			...
			UPDATE ADM.C_CENTRO_OPTVO SET
						[CL_CLIENTE] = @PIN_CL_CLIENTE
						,[CL_CENTRO_OPTVO] = @PIN_CL_CENTRO_OPTVO
						,[NB_CENTRO_OPTVO] = @PIN_NB_CENTRO_OPTVO
			...
			WHERE [ID_CENTRO_OPTVO] = @PIN_ID_CENTRO_OPTVO
			END
