...
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_AREA_INTERES] 
		...
		, @PIN_NB_AREA_INTERES AS nvarchar(200)
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
			...
			INSERT INTO ADM.C_AREA_INTERES
					   (
						 [CL_AREA_INTERES]
						, [NB_AREA_INTERES]
						, [FG_ACTIVO]
		...
		END ELSE BEGIN
			...
			UPDATE ADM.C_AREA_INTERES SET
				 [CL_AREA_INTERES] = @PIN_CL_AREA_INTERES
				, [NB_AREA_INTERES] = @PIN_NB_AREA_INTERES
