...
-- Description: Inserta un nuevo C_CALLE
-- =============================================
-- 20/11/2015 MS -  Se modifica el valor de retorno por XML
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_CALLE] 
		...
		, @PIN_CL_COLONIA AS nvarchar(10)
		, @PIN_CL_CALLE AS nvarchar(10)
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.C_CALLE
			INSERT INTO ADM.C_CALLE
					   ([CL_PAIS]
						, [CL_ESTADO]
						, [CL_MUNICIPIO]
						, [CL_COLONIA]
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.C_CALLE
			UPDATE ADM.C_CALLE SET
				[CL_PAIS] = @PIN_CL_PAIS
				, [CL_ESTADO] = @PIN_CL_ESTADO
				, [CL_MUNICIPIO] = @PIN_CL_MUNICIPIO
				, [CL_COLONIA] = @PIN_CL_COLONIA
				, [CL_CALLE] = @PIN_CL_CALLE
