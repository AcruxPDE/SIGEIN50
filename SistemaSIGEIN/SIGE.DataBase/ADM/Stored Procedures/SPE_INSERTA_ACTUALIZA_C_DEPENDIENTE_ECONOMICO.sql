...
-- Description: Inserta un nuevo C_DEPENDIENTE_ECONOMICO
-- =============================================
-- 20/11/2015 MS - Se modifica el valor de retorno
-- ============================================= 
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_DEPENDIENTE_ECONOMICO] 
		  @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_DEPENDIENTE_ECONOMICO AS int
		, @PIN_NB_DEPENDIENTE_ECONOMICO AS nvarchar(50)
		, @PIN_CL_PARENTEZCO AS nvarchar(20)
		, @PIN_CL_GENERO AS nvarchar(1)
		, @PIN_FE_NACIMIENTO AS date
		, @PIN_ID_BITACORA AS int
		, @PIN_CL_OCUPACION AS bit
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.C_DEPENDIENTE_ECONOMICO
			INSERT INTO ADM.C_DEPENDIENTE_ECONOMICO
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.C_DEPENDIENTE_ECONOMICO
			UPDATE ADM.C_DEPENDIENTE_ECONOMICO SET
				[NB_DEPENDIENTE_ECONOMICO] = @PIN_NB_DEPENDIENTE_ECONOMICO
				, [CL_PARENTEZCO] = @PIN_CL_PARENTEZCO
				, [CL_GENERO] = @PIN_CL_GENERO
				, [FE_NACIMIENTO] = @PIN_FE_NACIMIENTO
				, [ID_BITACORA] = @PIN_ID_BITACORA
				, [CL_OCUPACION] = @PIN_CL_OCUPACION
			...
			WHERE [ID_DEPENDIENTE_ECONOMICO] = @PIN_ID_DEPENDIENTE_ECONOMICO
