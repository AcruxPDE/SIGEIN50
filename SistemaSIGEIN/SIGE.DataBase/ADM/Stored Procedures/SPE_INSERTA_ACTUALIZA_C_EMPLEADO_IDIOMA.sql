...
-- Description: Inserta un nuevo registro en la tabla C_EMPLEADO_IDIOMA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_EMPLEADO_IDIOMA] 
		  @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_EMPLEADO_IDIOMA AS int
		, @PIN_ID_EMPLEADO AS int
		, @PIN_ID_CANDIDATO AS int
		, @PIN_ID_IDIOMA AS int
		, @PIN_PR_LECTURA AS decimal(5,2)
		, @PIN_PR_ESCRITURA AS decimal(5,2)
		, @PIN_PR_CONVERSACIONAL AS decimal(5,2)
		, @PIN_CL_INSTITUCION AS int
		, @PIN_NO_PUNTAJE AS decimal(10,3)
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.C_EMPLEADO_IDIOMA
			INSERT INTO ADM.C_EMPLEADO_IDIOMA
					   ([ID_EMPLEADO]
						, [ID_CANDIDATO]
						, [ID_IDIOMA]
						, [PR_LECTURA]
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.C_EMPLEADO_IDIOMA
			UPDATE ADM.C_EMPLEADO_IDIOMA SET
				[ID_EMPLEADO] = @PIN_ID_EMPLEADO
				, [ID_CANDIDATO] = @PIN_ID_CANDIDATO
				, [ID_IDIOMA] = @PIN_ID_IDIOMA
				, [PR_LECTURA] = @PIN_PR_LECTURA
				, [PR_ESCRITURA] = @PIN_PR_ESCRITURA
				, [PR_CONVERSACIONAL] = @PIN_PR_CONVERSACIONAL
				, [CL_INSTITUCION] = @PIN_CL_INSTITUCION
				, [NO_PUNTAJE] = @PIN_NO_PUNTAJE
			...
			WHERE [ID_EMPLEADO_IDIOMA] = @PIN_ID_EMPLEADO_IDIOMA
