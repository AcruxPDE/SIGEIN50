...
-- Description: Inserta un nuevo registro en la tabla C_EMPLEADO_RELACIONADO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_EMPLEADO_RELACIONADO] 
		  @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_EMPLEADO AS int
		, @PIN_ID_EMPLEADO_RELACIONADO AS int
		, @PIN_CL_TIPO_RELACION AS nvarchar(20)
		, @PIN_DS_EMPLEADO_RELACIONADO AS nvarchar(500)
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.C_EMPLEADO_RELACIONADO
			INSERT INTO ADM.C_EMPLEADO_RELACIONADO
					   ([ID_EMPLEADO]
			...
			VALUES
					   (@PIN_ID_EMPLEADO
						, @PIN_ID_EMPLEADO_RELACIONADO
						, @PIN_CL_TIPO_RELACION
						, @PIN_DS_EMPLEADO_RELACIONADO
						, @CFE_SISTEMA
						, @PIN_CL_USUARIO_APP_CREA
						, @PIN_NB_PROGRAMA_CREA
					)			
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.C_EMPLEADO_RELACIONADO
			UPDATE ADM.C_EMPLEADO_RELACIONADO SET
				[ID_EMPLEADO] = @PIN_ID_EMPLEADO
				, [ID_EMPLEADO_RELACIONADO] = @PIN_ID_EMPLEADO_RELACIONADO
				, [CL_TIPO_RELACION] = @PIN_CL_TIPO_RELACION
				, [DS_EMPLEADO_RELACIONADO] = @PIN_DS_EMPLEADO_RELACIONADO
		...
		AND [ID_EMPLEADO_RELACIONADO] = @PIN_ID_EMPLEADO_RELACIONADO
		AND [CL_TIPO_RELACION] = @PIN_CL_TIPO_RELACION				
		END
