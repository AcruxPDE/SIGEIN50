...
-- Description: Inserta un nuevo C_ESCOLARIDAD
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_ESCOLARIDAD] 
    	  @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_ESCOLARIDAD AS int
		, @PIN_CL_ESCOLARIDAD AS nvarchar(20)
		, @PIN_NB_ESCOLARIDAD AS nvarchar(100)
		, @PIN_DS_ESCOLARIDAD AS nvarchar(200)
		, @PIN_CL_NIVEL_ESCOLARIDAD AS nvarchar(20)
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.C_ESCOLARIDAD
			INSERT INTO ADM.C_ESCOLARIDAD
					   (  [CL_ESCOLARIDAD]
					    , [NB_ESCOLARIDAD]
						, [DS_ESCOLARIDAD]
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.C_ESCOLARIDAD
			UPDATE ADM.C_ESCOLARIDAD SET
				  [CL_ESCOLARIDAD] = @PIN_CL_ESCOLARIDAD,
				  [NB_ESCOLARIDAD] = @PIN_NB_ESCOLARIDAD
				, [DS_ESCOLARIDAD] = @PIN_DS_ESCOLARIDAD
			...
			WHERE [ID_ESCOLARIDAD] = @PIN_ID_ESCOLARIDAD
