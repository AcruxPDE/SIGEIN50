...
-- Description: Inserta un nuevo C_EVALUADOR_EXTERNO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_EVALUADOR_EXTERNO] 
	      @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_EVALUADOR_EXTERNO AS int
		, @PIN_CL_EVALUADOR_EXTERNO AS nvarchar(32)
		, @PIN_NB_EVALUADOR_EXTERNO AS nvarchar(100)
		, @PIN_DS_EVALUARDO_EXTERNO AS nvarchar(200)
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.C_EVALUADOR_EXTERNO
			INSERT INTO ADM.C_EVALUADOR_EXTERNO
			...
			VALUES
					   (@PIN_CL_EVALUADOR_EXTERNO
						, @PIN_NB_EVALUADOR_EXTERNO
						, @PIN_DS_EVALUARDO_EXTERNO
						, @PIN_FG_ACTIVO
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.C_EVALUADOR_EXTERNO
			UPDATE ADM.C_EVALUADOR_EXTERNO SET
				[CL_EVALUADOR_EXTERNO] = @PIN_CL_EVALUADOR_EXTERNO
				, [NB_EVALUADOR_EXTERNO] = @PIN_NB_EVALUADOR_EXTERNO
				, [DS_EVALUARDO_EXTERNO] = @PIN_DS_EVALUARDO_EXTERNO
			...
			WHERE [ID_EVALUADOR_EXTERNO] = @PIN_ID_EVALUADOR_EXTERNO
