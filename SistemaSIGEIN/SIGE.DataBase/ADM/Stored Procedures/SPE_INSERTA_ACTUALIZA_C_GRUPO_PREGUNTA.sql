...
-- Description: Inserta un nuevo registro en la tabla C_GRUPO_PREGUNTA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_GRUPO_PREGUNTA] 
	      @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_GRUPO_PREGUNTA AS int
		, @PIN_CL_GRUPO_PREGUNTA AS nvarchar(20)
		, @PIN_NB_GRUPO_PREGUNTA AS nvarchar(200)
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.C_GRUPO_PREGUNTA
			INSERT INTO ADM.C_GRUPO_PREGUNTA
					   ([ID_GRUPO_PREGUNTA]
						, [CL_GRUPO_PREGUNTA]
						, [NB_GRUPO_PREGUNTA]
						, [ID_PREGUNTA]
			...
			VALUES
					   (@PIN_ID_GRUPO_PREGUNTA
						, @PIN_CL_GRUPO_PREGUNTA
						, @PIN_NB_GRUPO_PREGUNTA
						, @PIN_ID_PREGUNTA
						, @CFE_SISTEMA
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.C_GRUPO_PREGUNTA
			UPDATE ADM.C_GRUPO_PREGUNTA SET
				[ID_GRUPO_PREGUNTA] = @PIN_ID_GRUPO_PREGUNTA
				, [CL_GRUPO_PREGUNTA] = @PIN_CL_GRUPO_PREGUNTA
				, [NB_GRUPO_PREGUNTA] = @PIN_NB_GRUPO_PREGUNTA
				, [ID_PREGUNTA] = @PIN_ID_PREGUNTA
			...
			WHERE 		[ID_GRUPO_PREGUNTA] = @PIN_ID_GRUPO_PREGUNTA
	AND [CL_GRUPO_PREGUNTA] = @PIN_CL_GRUPO_PREGUNTA
	AND [NB_GRUPO_PREGUNTA] = @PIN_NB_GRUPO_PREGUNTA
	AND [ID_PREGUNTA] = @PIN_ID_PREGUNTA			
		END
