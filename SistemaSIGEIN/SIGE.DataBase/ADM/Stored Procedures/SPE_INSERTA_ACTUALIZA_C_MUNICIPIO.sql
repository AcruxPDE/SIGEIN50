...
-- Description: Inserta un nuevo C_MUNICIPIO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_MUNICIPIO] 
		  @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_MUNICIPIO AS int
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.C_MUNICIPIO
			INSERT INTO ADM.C_MUNICIPIO
					   ([CL_PAIS]
						, [CL_ESTADO]
						, [CL_MUNICIPIO]
						, [NB_MUNICIPIO]
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.C_MUNICIPIO
			UPDATE ADM.C_MUNICIPIO SET
				[CL_PAIS] = @PIN_CL_PAIS
			...
			WHERE [ID_MUNICIPIO] = @PIN_ID_MUNICIPIO
