...
-- CRETAE date: 02/11/2015
-- Description: Inserta un nuevo registro en la tabla C_PARIENTE
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_C_PARIENTE] 
	      @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_PARIENTE AS int
		, @PIN_NB_PARIENTE AS nvarchar(50)
		...
		, @PIN_CL_OCUPACION AS nvarchar(50)
		, @PIN_FG_DEPENDIENTE AS bit
...
BEGIN  
	...
	,@CFE_SISTEMA DATETIME = dbo.F_GETDATE()
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.C_PARIENTE
			INSERT INTO ADM.C_PARIENTE
					   (NB_PARIENTE
						, CL_PARENTESCO
						, CL_GENERO
						, FE_NACIMIENTO
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.C_PARIENTE
			UPDATE ADM.C_PARIENTE SET
				NB_PARIENTE = @PIN_NB_PARIENTE
				, CL_PARENTESCO = @PIN_CL_PARENTEZCO
				...
				, FG_DEPENDIENTE = @PIN_FG_DEPENDIENTE
			...
			WHERE ID_PARIENTE = @PIN_ID_PARIENTE
