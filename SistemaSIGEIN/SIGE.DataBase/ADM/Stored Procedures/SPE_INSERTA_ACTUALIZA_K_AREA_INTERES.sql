...
-- Description: Inserta un nuevo registro en la tabla K_AREA_INTERES
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_K_AREA_INTERES] 
	      @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_CANDIDATO_AREA_INTERES AS int
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.K_AREA_INTERES
			INSERT INTO ADM.K_AREA_INTERES
					   ([ID_CANDIDATO]
						, [ID_AREA_INTERES]
						, [FE_CREACION]
						, [CL_USUARIO_APP_CREA]
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.K_AREA_INTERES
			UPDATE ADM.K_AREA_INTERES SET
				[ID_CANDIDATO] = @PIN_ID_CANDIDATO
				, [ID_AREA_INTERES] = @PIN_ID_AREA_INTERES
			...
			WHERE [ID_CANDIDATO_AREA_INTERES] = @PIN_ID_CANDIDATO_AREA_INTERES
