...
-- Description: Inserta un nuevo registro en la tabla K_CUESTIONARIO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_K_CUESTIONARIO] 
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.K_CUESTIONARIO
			...
			VALUES
					   (@PIN_ID_EVALUADO
						, @PIN_ID_EVALUADO_EVALUADOR
						, @CFE_SISTEMA
						, @PIN_CL_USUARIO_APP_CREA
						, @PIN_NB_PROGRAMA_CREA
					)			
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.K_CUESTIONARIO
			UPDATE ADM.K_CUESTIONARIO SET
				[ID_EVALUADO] = @PIN_ID_EVALUADO
				, [ID_EVALUADO_EVALUADOR] = @PIN_ID_EVALUADO_EVALUADOR
