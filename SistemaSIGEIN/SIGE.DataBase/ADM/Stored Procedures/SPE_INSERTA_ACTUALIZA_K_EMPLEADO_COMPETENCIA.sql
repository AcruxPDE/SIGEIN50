...
-- Description: Inserta un nuevo registro en la tabla K_EMPLEADO_COMPETENCIA
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_K_EMPLEADO_COMPETENCIA] 
	      @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_EMPLEADO_COMPETENCIA AS int
		, @PIN_ID_EMPLEADO AS int
		, @PIN_ID_COMPETENCIA AS int
		, @PIN_NO_CALIFICACION AS decimal(8,3)
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.K_EMPLEADO_COMPETENCIA
			INSERT INTO ADM.K_EMPLEADO_COMPETENCIA
					   ([ID_EMPLEADO]
						, [ID_COMPETENCIA]
						, [NO_CALIFICACION]
						, [FE_CREACION]
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.K_EMPLEADO_COMPETENCIA
			UPDATE ADM.K_EMPLEADO_COMPETENCIA SET
				[ID_EMPLEADO] = @PIN_ID_EMPLEADO
				, [ID_COMPETENCIA] = @PIN_ID_COMPETENCIA
				, [NO_CALIFICACION] = @PIN_NO_CALIFICACION
			...
			WHERE [ID_EMPLEADO_COMPETENCIA] = @PIN_ID_EMPLEADO_COMPETENCIA
