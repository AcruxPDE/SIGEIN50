...
-- Description: Inserta un nuevo registro en la tabla K_EVALUADO_EVALUADOR
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_K_EVALUADO_EVALUADOR] 
	     @XML_RESULTADO XML = '' OUT       --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_ID_EVALUADO_EVALUADOR AS int
		, @PIN_ID_PERIODO AS int
		, @PIN_ID_EVALUADOR_PERIODO AS int
		, @PIN_ID_PUESTO_EVALUADOR AS int
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.K_EVALUADO_EVALUADOR
			INSERT INTO ADM.K_EVALUADO_EVALUADOR
					   ([ID_PERIODO]
			...
			VALUES
					   (@PIN_ID_PERIODO
						, @PIN_ID_EVALUADOR_PERIODO
						, @PIN_ID_PUESTO_EVALUADOR
						, @PIN_NO_VALOR
						, @CFE_SISTEMA
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.K_EVALUADO_EVALUADOR
			UPDATE ADM.K_EVALUADO_EVALUADOR SET
				[ID_PERIODO] = @PIN_ID_PERIODO
				, [ID_EVALUADOR_PERIODO] = @PIN_ID_EVALUADOR_PERIODO
				, [ID_PUESTO_EVALUADOR] = @PIN_ID_PUESTO_EVALUADOR
			...
			WHERE [ID_EVALUADO_EVALUADOR] = @PIN_ID_EVALUADO_EVALUADOR
