...
-- Description: Inserta un nuevo S_TIPO_DATO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_S_TIPO_DATO] 
	      @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_CL_TIPO_DATO AS nvarchar(30)
		, @PIN_NB_TIPO_DATO AS nvarchar(100)
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.S_TIPO_DATO
			INSERT INTO ADM.S_TIPO_DATO
					   ([CL_TIPO_DATO]
						, [NB_TIPO_DATO]
					)
			VALUES
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.S_TIPO_DATO
			UPDATE ADM.S_TIPO_DATO SET
				[CL_TIPO_DATO] = @PIN_CL_TIPO_DATO
				, [NB_TIPO_DATO] = @PIN_NB_TIPO_DATO       
			WHERE [CL_TIPO_DATO] = @PIN_CL_TIPO_DATO AND
				 [NB_TIPO_DATO] = @PIN_NB_TIPO_DATO
		END
