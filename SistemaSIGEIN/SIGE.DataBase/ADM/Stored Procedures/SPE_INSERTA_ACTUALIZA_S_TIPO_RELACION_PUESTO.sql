...
-- Description: Inserta un nuevo registro en la tabla S_TIPO_RELACION_PUESTO
-- =============================================
CREATE PROCEDURE [ADM].[SPE_INSERTA_ACTUALIZA_S_TIPO_RELACION_PUESTO] 
	     @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
    	, @PIN_CL_TIPO_RELACION AS nvarchar(20)
		, @PIN_NB_TIPO_RELACION AS nvarchar(100)
		, @PIN_DS_TIPO_RELACION AS nvarchar(200)
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  ADM.S_TIPO_RELACION_PUESTO
			INSERT INTO ADM.S_TIPO_RELACION_PUESTO
					   ([NB_TIPO_RELACION]
						, [DS_TIPO_RELACION]
					)
			VALUES
					   (@PIN_NB_TIPO_RELACION
						, @PIN_DS_TIPO_RELACION
					)			
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  ADM.S_TIPO_RELACION_PUESTO
			UPDATE ADM.S_TIPO_RELACION_PUESTO SET
				[NB_TIPO_RELACION] = @PIN_NB_TIPO_RELACION
				, [DS_TIPO_RELACION] = @PIN_DS_TIPO_RELACION
			       
			WHERE [CL_TIPO_RELACION] = @PIN_CL_TIPO_RELACION
