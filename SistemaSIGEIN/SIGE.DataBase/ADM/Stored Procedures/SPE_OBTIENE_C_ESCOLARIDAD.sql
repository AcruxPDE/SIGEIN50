...
-- =============================================
CREATE PROCEDURE [ADM].[SPE_OBTIENE_C_ESCOLARIDAD] 
	    @PIN_ID_ESCOLARIDAD AS int = NULL,
        @PIN_CL_ESCOLARIDAD AS nvarchar(20) = NULL,
...
AS   
	...
	WHERE (@PIN_ID_ESCOLARIDAD IS NULL OR (@PIN_ID_ESCOLARIDAD IS NOT NULL AND [ID_ESCOLARIDAD] = @PIN_ID_ESCOLARIDAD)) AND 
			(@PIN_CL_ESCOLARIDAD IS NULL OR (@PIN_CL_ESCOLARIDAD IS NOT NULL AND [CL_ESCOLARIDAD] = @PIN_CL_ESCOLARIDAD)) AND 
	...
	--EXECUTE [ADM].[SPE_OBTIENE_C_ESCOLARIDAD] NULL,NULL,NULL,'POSGRO',NULL,NULL
