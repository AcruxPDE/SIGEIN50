...
-- Description: Elimina un registro de la tabla C_CUESTIONARIO
-- =============================================
CREATE PROCEDURE [IDP].[SPE_ELIMINA_C_CUESTIONARIO]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		DELETE FROM IDP.C_CUESTIONARIO
		...
		SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó el cuestionario satisfactoriamente', 'ES')
		SET @XML_RESULTADO = DBO.F_ERROR_INSERTAR_MENSAJES(@XML_RESULTADO, 'Se eliminó el cuestionario satisfactoriamente', 'EN')
