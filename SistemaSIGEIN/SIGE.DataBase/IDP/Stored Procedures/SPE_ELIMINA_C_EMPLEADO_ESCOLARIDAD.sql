...
-- Description: Elimina un registro de la tabla C_EMPLEADO_ESCOLARIDAD
-- =============================================
CREATE PROCEDURE [IDP].[SPE_ELIMINA_C_EMPLEADO_ESCOLARIDAD]
...
BEGIN
	...
	BEGIN TRY		   			
		...
		BEGIN
			...
			SET @V_EXIST_TRAN = 1
		END	
		--SE BORRA EL REGISTRO EN LA TABLA  IDP.C_EMPLEADO_ESCOLARIDAD
		DELETE FROM IDP.C_EMPLEADO_ESCOLARIDAD
