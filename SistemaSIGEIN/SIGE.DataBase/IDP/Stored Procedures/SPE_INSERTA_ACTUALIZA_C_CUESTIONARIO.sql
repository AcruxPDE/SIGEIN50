...
-- Description: Inserta un nuevo registro en la tabla C_CUESTIONARIO
-- =============================================
CREATE PROCEDURE [IDP].[SPE_INSERTA_ACTUALIZA_C_CUESTIONARIO] 
		  @XML_RESULTADO XML = '' OUT      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
		, @PIN_ID_CUESTIONARIO AS int
		, @PIN_CL_CUESTIONARIO AS nvarchar(10) 
		, @PIN_NB_CUESTIONARIO AS nvarchar(100) 
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		IF @PIN_TIPO_TRANSACCION='I'
	    	BEGIN
			--SE INSERTA EL REGISTRO EN LA TABLA  IDP.C_CUESTIONARIO
			INSERT INTO IDP.C_CUESTIONARIO
					   (
						 [CL_CUESTIONARIO]
						, [NB_CUESTIONARIO]
						, [FE_CREACION]
		...
		END ELSE BEGIN
			--SE ACTUALIZA EL REGISTRO EN LA TABLA  IDP.C_CUESTIONARIO
			UPDATE IDP.C_CUESTIONARIO SET
				 [CL_CUESTIONARIO] = @PIN_CL_CUESTIONARIO
				, [NB_CUESTIONARIO] = @PIN_NB_CUESTIONARIO
