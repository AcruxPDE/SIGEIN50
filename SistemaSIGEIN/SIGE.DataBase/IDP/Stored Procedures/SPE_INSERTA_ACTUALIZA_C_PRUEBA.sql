...
-- Description: Inserta un nuevo registro en la tabla C_PRUEBA
-- =============================================
CREATE PROCEDURE [IDP].[SPE_INSERTA_ACTUALIZA_C_PRUEBA] 
		  @XML_RESULTADO XML = '' OUT,      --APLICA PARA REGRESAR UN NÚMERO 0 PARA ERROR Y 1 PARA CORRECTO
	      @PIN_ID_PRUEBA int 
		, @PIN_CL_PRUEBA AS nvarchar(10) 
		, @PIN_NB_PRUEBA AS nvarchar(200)
		, @PIN_ID_CUESTIONARIO AS INT 
		, @PIN_NO_TIEMPO_PRUEBA AS smallint 
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		END ELSE BEGIN
			...
			UPDATE IDP.C_PRUEBA SET
				 [CL_PRUEBA] = @PIN_CL_PRUEBA
				, [NB_PRUEBA] = @PIN_NB_PRUEBA
				, [ID_CUESTIONARIO] = @PIN_ID_CUESTIONARIO
				, [NO_TIEMPO_PRUEBA] = @PIN_NO_TIEMPO_PRUEBA
