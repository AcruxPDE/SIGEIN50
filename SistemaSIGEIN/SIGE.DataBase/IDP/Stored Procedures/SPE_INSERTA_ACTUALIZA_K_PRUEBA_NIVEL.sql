...
-- Description: Inserta un nuevo registro en la tabla K_PRUEBA_NIVEL
-- =============================================
CREATE PROCEDURE [IDP].[SPE_INSERTA_ACTUALIZA_K_PRUEBA_NIVEL] 
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		IF @PIN_TIPO_TRANSACCION='I'
			...
			INSERT INTO IDP.K_PRUEBA_NIVEL
					   (
						 [ID_PRUEBA_NIVEL]
						, [ID_PRUEBA]
						, [FE_CREACION]
		...
		END ELSE BEGIN
			...
			UPDATE IDP.K_PRUEBA_NIVEL SET
				 [ID_PRUEBA_NIVEL] = @PIN_ID_PRUEBA_NIVEL
