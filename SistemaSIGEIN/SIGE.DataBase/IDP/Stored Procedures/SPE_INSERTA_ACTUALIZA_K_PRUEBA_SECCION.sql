...
-- =============================================
CREATE PROCEDURE [IDP].[SPE_INSERTA_ACTUALIZA_K_PRUEBA_SECCION] 
		...
		, @PIN_CL_PRUEBA_SECCION AS nvarchar(20)
		, @PIN_NB_PRUEBA_SECCION AS nvarchar(200)
...
BEGIN  
	...
	DECLARE @V_EXIST_TRAN BIT = 0
		...
		IF @PIN_TIPO_TRANSACCION='I'
			...
			INSERT INTO IDP.K_PRUEBA_SECCION
					   (
						  [ID_PRUEBA]
						, [CL_PRUEBA_SECCION]
						, [NB_PRUEBA_SECCION]
			...
			VALUES
					   ( @PIN_ID_PRUEBA
						, @PIN_CL_PRUEBA_SECCION
						, @PIN_NB_PRUEBA_SECCION
						, @PIN_NO_TIEMPO
						, @PIN_CL_ESTADO
						, @PIN_FE_INICIO
						, @PIN_FE_TERMINO
		...
		END ELSE BEGIN
			...
			UPDATE IDP.K_PRUEBA_SECCION SET
				 [ID_PRUEBA] = @PIN_ID_PRUEBA
				, [CL_PRUEBA_SECCION] = @PIN_CL_PRUEBA_SECCION
				, [NB_PRUEBA_SECCION] =   @PIN_NB_PRUEBA_SECCION
