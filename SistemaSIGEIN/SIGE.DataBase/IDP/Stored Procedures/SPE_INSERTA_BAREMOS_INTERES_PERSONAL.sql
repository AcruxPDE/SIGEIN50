...
-- =============================================
CREATE PROCEDURE [IDP].[SPE_INSERTA_BAREMOS_INTERES_PERSONAL]
...
BEGIN  
	...
	;WITH T_VARIABLES AS (
		SELECT 'INTERES_REP_T' AS CL_VARIABLE_REPORTE, 'IN-TEÓRICO' AS CL_VARIABLE_BAREMOS UNION ALL
		SELECT 'INTERES_REP_E' AS CL_VARIABLE_REPORTE, 'IN-ECONÓMICO' AS CL_VARIABLE_BAREMOS UNION ALL
		SELECT 'INTERES_REP_A' AS CL_VARIABLE_REPORTE, 'IN-ARTÍSTICO ESTÉTICO' AS CL_VARIABLE_BAREMOS UNION ALL
		SELECT 'INTERES_REP_S' AS CL_VARIABLE_REPORTE, 'IN-SOCIAL' AS CL_VARIABLE_BAREMOS UNION ALL
		SELECT 'INTERES_REP_P' AS CL_VARIABLE_REPORTE, 'IN-POLÍTICO' AS CL_VARIABLE_BAREMOS UNION ALL
		SELECT 'INTERES_REP_R' AS CL_VARIABLE_REPORTE, 'IN-REGULATORIO' AS CL_VARIABLE_BAREMOS
	), T_RESULTADOS AS (
	...
	SELECT 4 AS CL_TIPO_RESULTADO, CV2.ID_VARIABLE, [IDP].[F_OBTIENE_VALORES_BAREMOS](4, KR.NO_VALOR, NULL), @V_ID_CUESTIONARIO, @V_FE_SISTEMA, @PIN_CL_USUARIO_APP, @PIN_NB_PROGRAMA
	FROM T_VARIABLES TV
