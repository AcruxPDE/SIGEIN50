...
-- =============================================
CREATE PROCEDURE [IDP].[SPE_INSERTA_BAREMOS_LABORAL2]
...
BEGIN  
	...
	;WITH T_VARIABLES AS (
	SELECT 'LABORAL2-REP-DAAPF' AS CL_VARIABLE_REPORTE, 'L2-DA Y APOYA' AS CL_VARIABLE_BAREMOS UNION ALL
	SELECT 'LABORAL2-REP-TMCTF' AS CL_VARIABLE_REPORTE, 'L2-TOMA Y CONTROLA' AS CL_VARIABLE_BAREMOS UNION ALL
	SELECT 'LABORAL2-REP-MTCSF' AS CL_VARIABLE_REPORTE, 'L2-MANTIENE Y CONSERVA' AS CL_VARIABLE_BAREMOS UNION ALL
	SELECT 'LABORAL2-REP-ADNGF' AS CL_VARIABLE_REPORTE, 'L2-ADAPTA Y NEGOCIA' AS CL_VARIABLE_BAREMOS 
	), T_RESULTADOS AS (
	...
	SELECT 4 AS CL_TIPO_RESULTADO, CV2.ID_VARIABLE, [IDP].[F_OBTIENE_VALORES_BAREMOS](1, KR.NO_VALOR, NULL), @V_ID_CUESTIONARIO, @V_FE_SISTEMA, @PIN_CL_USUARIO_APP, @PIN_NB_PROGRAMA
	FROM T_VARIABLES TV
