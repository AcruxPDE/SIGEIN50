...
-- =============================================
CREATE PROCEDURE [IDP].[SPE_INSERTA_BAREMOS_TECNICAPC]
...
BEGIN  
	...
	;WITH T_VARIABLES AS (
		SELECT 'TECNICAPC_REP_S' AS CL_VARIABLE_REPORTE, 'TP-SOFTWARE' AS CL_VARIABLE_BAREMOS UNION ALL
		SELECT 'TECNICAPC_REP_I' AS CL_VARIABLE_REPORTE, 'TP-INTERNET' AS CL_VARIABLE_BAREMOS UNION ALL
		SELECT 'TECNICAPC_REP_H' AS CL_VARIABLE_REPORTE, 'TP-HARDWARE' AS CL_VARIABLE_BAREMOS UNION ALL
		SELECT 'TECNICAPC_REP_C' AS CL_VARIABLE_REPORTE, 'TP-COMUNICACIONES' AS CL_VARIABLE_BAREMOS 
	), T_RESULTADOS AS (
	...
	SELECT 4 AS CL_TIPO_RESULTADO, CV2.ID_VARIABLE, [IDP].[F_OBTIENE_VALORES_BAREMOS](5, KR.NO_VALOR, TV.CL_VARIABLE_REPORTE), @V_ID_CUESTIONARIO, @V_FE_SISTEMA, @PIN_CL_USUARIO_APP, @PIN_NB_PROGRAMA
	FROM T_VARIABLES TV
