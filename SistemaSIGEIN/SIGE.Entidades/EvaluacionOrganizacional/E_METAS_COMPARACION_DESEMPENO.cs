...
namespace SIGE.Entidades.EvaluacionOrganizacional
{
    ...
    public class E_METAS_COMPARACION_DESEMPENO
    {
        ...
        public Nullable<bool> FG_VALIDA_CUMPLIMIENTO { get; set; }
        public Nullable<bool> FG_EVALUAR { get; set; }
        ...
        public string PR_CUMPLIMIENTO_META_STR { get; set; }
