...
namespace SIGE.Entidades
{
    ...
    public partial class SPE_OBTIENE_METAS_COMPARAR_DESEMPENO_Result
    {
        public int ID_META_EVALUADO { get; set; }
        public Nullable<int> ID_PERIODO { get; set; }
        public Nullable<int> ID_EVALUADO_PERIODO { get; set; }
        public Nullable<long> NO_META { get; set; }
        ...
        public decimal PR_META { get; set; }
        public string NB_RESULTADO { get; set; }
        public decimal PR_RESULTADO { get; set; }
        public int CL_NIVEL { get; set; }
        public decimal PR_CUMPLIMIENTO_META { get; set; }
        public bool FG_EVIDENCIA { get; set; }
        public decimal PR_EVALUADO { get; set; }
