...
namespace SIGE.Negocio.AdministracionSitio
{
    ...
    {
        public List<SPE_OBTIENE_PLAZAS_Result> ObtienePlazas(int? pIdPlaza = null, XElement pXmlSeleccion = null, int? pID_EMPRESA = null)
        {
            PlazaOperaciones oPlaza = new PlazaOperaciones();
            return oPlaza.ObtenerPlazas(pIdPlaza, pXmlSeleccion, pID_EMPRESA);
        }
