...
namespace SIGE.Negocio.Administracion
{
    public class PuestoNegocio
    {
        ...
        public E_RESULTADO InsertaActualizaPuesto(string tipo_transaccion, E_PUESTO V_M_PUESTO, string usuario, string programa,string pXmlOcupacion)
        {
            PuestoOperaciones operaciones = new PuestoOperaciones();
            return UtilRespuesta.EnvioRespuesta(operaciones.InsertarActualizarPuesto(tipo_transaccion, V_M_PUESTO, usuario, programa,pXmlOcupacion));
        }
