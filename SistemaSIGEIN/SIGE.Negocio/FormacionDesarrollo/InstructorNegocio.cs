...
namespace SIGE.Negocio.FormacionDesarrollo
{
    public class InstructorNegocio
    {
        ...
        public List<E_INSTRUCTORES> ObtieneInstructor(int? pIdInstructor)
        {
            ...
            List<E_INSTRUCTORES> vInstructorCompetencia = nInstructorCurso.ObtenerInstructores(pIdInstructor, null, null, null, null);
        ...
        public List<E_INSTRUCTOR_COMPETENCIA> ObtieneInstructorCompetencia(int? pIdInstructor)
        {
            ...
            List<E_INSTRUCTORES> vInstructorCompetencia = nInstructorCompetencia.ObtenerInstructores(pIdInstructor, null, null, null, null);
