...
{
    public partial class ReporteResponsabilidadPuesto : System.Web.UI.Page
    {
        ...
        private void ExportarExcel()
        {
            ...
            grdEmpleados.Rebind();
            grdEmpleados.ExportSettings.Excel.Format = GridExcelExportFormat.Xlsx;
            grdEmpleados.ExportSettings.IgnorePaging = true;
            grdEmpleados.ExportSettings.ExportOnlyData = true;
            grdEmpleados.ExportSettings.OpenInNewWindow = true;
        ...
        protected void grdEmpleados_NeedDataSource(object sender, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
        {
            ...
            List<E_RESPONSABILIDAD> listaEmpleados = new List<E_RESPONSABILIDAD>();
            listaEmpleados = empleados.ObtieneResponsabilidadPuesto();
