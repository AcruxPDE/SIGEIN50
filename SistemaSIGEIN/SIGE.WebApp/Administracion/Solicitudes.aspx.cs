...
namespace SIGE.WebApp.Administracion // Se cambia el namespace de SIGE.WebApp.IDP así como el MasterPageFile de ~/IDP/MenuIDP.master para no vincular las solicitudes con el módulo IDP
{
    public partial class Solicitudes : System.Web.UI.Page
    {
        ...
        private bool vFgEliminarCartera;
        private bool vFgImpresion;
        ...
        {
            btnGuardar.Enabled = vAgregarSolicitud = ContextoUsuario.oUsuario.TienePermiso("A.A");
            btnEditar.Enabled = vModificarSolicitud = ContextoUsuario.oUsuario.TienePermiso("A.B");
            btnEliminar.Enabled = vEliminarSolicitud = ContextoUsuario.oUsuario.TienePermiso("A.C");
            btnActualizarCartera.Enabled = vFgEliminarCartera = ContextoUsuario.oUsuario.TienePermiso("A.D");
            btnImpresion2.Enabled = vFgImpresion = ContextoUsuario.oUsuario.TienePermiso("A.E");
