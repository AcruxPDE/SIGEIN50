<%@ Page Title="" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="VentanaCentroOperativo.aspx.cs" Inherits="SIGE.WebApp.Administracion.VentanaCentroOperativo" %>
...
<%--     <div style="clear:both;"/>
    ...
    <div style="clear:both;">
        <div class="divControlesBoton">    
            <telerik:RadButton ID="btnGuardarCentroOptvo"
                 runat="server" 
                Width="100px" 
                Text="Guardar"  
                AutoPostBack="true" 
                OnClick="btnGuardarCentroOptvo_Click"
                ></telerik:RadButton>
                
            <telerik:RadButton ID="btnCancelarCentroOptvo" 
                runat="server" 
                Width="100px" 
                Text="Cancelar" 
                AutoPostBack="true"  
                OnClientClicking="closeWindow" 
                OnClick="btnCancelarCentroOptvo_Click" ></telerik:RadButton>
        </div>
    </div>
