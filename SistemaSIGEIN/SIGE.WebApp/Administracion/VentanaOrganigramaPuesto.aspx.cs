...
{
    public partial class VentanaOrganigramaPuesto : System.Web.UI.Page
    {
        #region Variables 
        ...
        protected void CargarDatosOrganigramaPuesto(int? pIdEmpresa = null, bool? pFgMostrarEmpleados = false, int? pIdPuesto = null, int? pIdDepartamento = null, string pClCampo = null, int? pNoNiveles = null)
        {
            ...
            if (vOrganigrama.lstNodoDescendencia.Count == 0)
                vOrganigrama.lstNodoDescendencia.Add(new E_ORGANIGRAMA_NODO_PUESTO() { nbNodo = "No hay datos" });
               ...
               if (Request.Params["idPuesto"] != null)
                {
                    ...
                    CargarDatosOrganigramaPuesto(vIdEmpresa, false, vIdPuesto, vIdDepartamento, vClCampo, vNoNiveles);
                }
                // CargarDatosEmpresas();
