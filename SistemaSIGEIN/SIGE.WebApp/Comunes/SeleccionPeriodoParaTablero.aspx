<%@ Page Title="" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="SeleccionPeriodoParaTablero.aspx.cs" Inherits="SIGE.WebApp.Comunes.SeleccionPeriodoParaTablero" %>
        ...
        function addSelection() {
            ...
            if (selectedItems.length > 0) {
                for (i = 0; i < selectedItems.length; i++) {
                    ...
                    var tipoPeriodo = '<%= vClTipoPeriodo %>'
                    var vPeriodo = {
