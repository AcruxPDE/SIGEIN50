<%@ Page Title="" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="SeleccionSolicitud.aspx.cs" Inherits="SIGE.WebApp.Comunes.SeleccionSolicitud" %>
        ...
        function addSelection() {
            ...
            if (selectedItems.length > 0) {
                for (i = 0; i < selectedItems.length; i++) {
                    ...
                    var vEmpleado = {
                        idSolicitud: selectedItem.getDataKeyValue("ID_SOLICITUD"),
                        idCandidato: selectedItem.getDataKeyValue("ID_CANDIDATO"),
                        clSolicitud: masterTable.getCellByColumnUniqueName(selectedItem, "K_SOLICITUD_CL_SOLICITUD").innerHTML,
                ...
                browserWnd.radalert("Selecciona una solicitud.", 400, 150, "Aviso");
            }
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="grdSolicitudes">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdSolicitudes" UpdatePanelHeight="100%" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="ftrGrdSolicitudes">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="ftrGrdSolicitudes" />
                    <telerik:AjaxUpdatedControl ControlID="grdSolicitudes" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
        ...
        <telerik:RadSplitter ID="splSolicitudes" runat="server" Width="100%" Height="100%" BorderSize="0">
            <telerik:RadPane ID="rpnGridSolicitudes" runat="server">
                <div style="height: calc(100% - 55px);">
                    <telerik:RadGrid ID="grdSolicitudes" HeaderStyle-Font-Bold="true" runat="server" Height="100%" AllowMultiRowSelection="true"  AutoGenerateColumns="false" EnableHeaderContextMenu="true" ShowGroupPanel="true" AllowSorting="true" OnItemDataBound="grdSolicitudes_ItemDataBound">
                        <ClientSettings>
                        ...
                        <MasterTableView ClientDataKeyNames="ID_SOLICITUD,ID_CANDIDATO" EnableColumnsViewState="false" DataKeyNames="ID_SOLICITUD" AllowPaging="true" AllowFilteringByColumn="true" ShowHeadersWhenNoRecords="true" EnableHeaderContextFilterMenu="true">
                            <Columns>
                                <telerik:GridClientSelectColumn Exportable="false" HeaderStyle-Width="35" ></telerik:GridClientSelectColumn>
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="true" HeaderStyle-Width="130" FilterControlWidth="60" HeaderText="Clave de solicitud" DataField="K_SOLICITUD_CL_SOLICITUD" UniqueName="K_SOLICITUD_CL_SOLICITUD"></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="true" HeaderStyle-Width="150" FilterControlWidth="80" HeaderText="Nombre (C)" DataField="C_CANDIDATO_NB_CANDIDATO" UniqueName="C_CANDIDATO_NB_CANDIDATO"></telerik:GridBoundColumn>
                                <telerik:GridDateTimeColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="true" HeaderStyle-Width="150" FilterControlWidth="80" HeaderText="Fecha de solicitud" DataField="K_SOLICITUD_FE_SOLICITUD" UniqueName="K_SOLICITUD_FE_SOLICITUD" DataFormatString="{0:d}"></telerik:GridDateTimeColumn>
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="true" HeaderStyle-Width="150" FilterControlWidth="80" HeaderText="Clave empleado (E)" DataField="M_EMPLEADO_CL_EMPLEADO" UniqueName="M_EMPLEADO_CL_EMPLEADO"></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="true" HeaderStyle-Width="150" FilterControlWidth="80" HeaderText="Clave estado de solicitud" DataField="K_SOLICITUD_CL_SOLICITUD_ESTATUS" UniqueName="K_SOLICITUD_CL_SOLICITUD_ESTATUS"></telerik:GridBoundColumn>
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="true" HeaderStyle-Width="200" FilterControlWidth="130" HeaderText="No. Requisición" DataField="M_DEPARTAMENTO_NO_REQUISICION" UniqueName="M_DEPARTAMENTO_NO_REQUISICION"></telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="false" HeaderStyle-Width="150" FilterControlWidth="80" HeaderText="Nombre completo (C)" DataField="C_CANDIDATO_NB_EMPLEADO_COMPLETO" UniqueName="C_CANDIDATO_NB_EMPLEADO_COMPLETO"></telerik:GridBoundColumn>
                                ...
                                <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="true" HeaderStyle-Width="110" FilterControlWidth="40" HeaderText="Nombre áctivo (E)" DataField="NB_ACTIVO" UniqueName="NB_ACTIVO"></telerik:GridBoundColumn>
                ...
                <telerik:RadSlidingZone ID="slzOpciones" runat="server" Width="30" ClickToOpen="true" SlideDirection="Left">
                    <telerik:RadSlidingPane ID="slpAdvSearch" runat="server" Title="Búsqueda avanzada" Width="500" MinWidth="500">
                        <div style="padding: 20px;">
                            <telerik:RadFilter runat="server" ID="ftrGrdSolicitudes" FilterContainerID="grdSolicitudes" ShowApplyButton="true" Height="100">
