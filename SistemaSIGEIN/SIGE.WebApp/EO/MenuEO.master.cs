...
{
    public partial class MenuEO : System.Web.UI.MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                //if (ContextoApp.EO.LicenciaED.MsgActivo == "1")
                //{
                    ...
                    //List<E_MENU> lstMenu = Utileria.CrearMenuLista(lstMenuModulo, "EVALUACION", true);
                    List<E_MENU> lstMenu = Utileria.CrearMenuLista(lstMenuModulo, vClModulo, true);
                ...
                //else
                //{
                //    UtilMensajes.MensajeResultadoDB(RadWindowManager1, ContextoApp.EO.LicenciaED.MsgActivo, E_TIPO_RESPUESTA_DB.WARNING);
