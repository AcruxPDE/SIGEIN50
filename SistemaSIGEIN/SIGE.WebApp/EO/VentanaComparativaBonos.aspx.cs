...
{
    public partial class VentanaComparativaBonos : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (ContextoPeriodos.oLstPeriodosBonos != null)
                {
                    foreach (E_SELECCION_PERIODOS_DESEMPENO item in ContextoPeriodos.oLstPeriodosBonos)
                    {
