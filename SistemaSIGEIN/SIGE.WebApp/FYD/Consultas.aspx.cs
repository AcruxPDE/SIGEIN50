...
namespace SIGE.WebApp.FYD
{
    public partial class Consultas : System.Web.UI.Page
    {
        ...
        //TODO: Poner en tablas con la clase especificada los botones de filtros
        ...
        protected void btnReporteMateriales_Click(object sender, EventArgs e)
        {
            AbrirReporte(Guid.NewGuid(), "OpenListaMaterialesWindow(\"{0}\");");
        }

        protected void btnReporteCosto_Click(object sender, EventArgs e)
        {
            AbrirReporte(Guid.NewGuid(), "OpenCostoCapacitacionWindow(\"{0}\");");
        }
