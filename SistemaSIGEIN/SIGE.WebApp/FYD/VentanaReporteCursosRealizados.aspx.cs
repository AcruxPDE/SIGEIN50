...
{
    public partial class VentanaReporteCursosRealizados : System.Web.UI.Page
    {
        #region Variables

        private Guid vIdReporte
        {
            get { return (Guid)ViewState["vs_vrcr_id_reporte"]; }
            set { ViewState["vs_vrcr_id_reporte"] = value; }
        }
