                                ...
                                <telerik:RadGrid
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID_SOLICITUD,ID_CANDIDATO,ID_BATERIA, CL_TOKEN, CL_SOLICITUD_ESTATUS, ESTATUS" EnableColumnsViewState="false" DataKeyNames="ID_SOLICITUD,ID_BATERIA, ESTATUS, CL_SOLICITUD" AllowPaging="true" AllowFilteringByColumn="true" ShowHeadersWhenNoRecords="true" EnableHeaderContextFilterMenu="true">
                                        <Columns>
                                            ...
                                            <telerik:GridDateTimeColumn DataFormatString="{0:d}" AutoPostBackOnFilter="true" Visible="true" Display="true" HeaderStyle-Width="150" FilterControlWidth="90" HeaderText="Fecha de aplicación" DataField="FE_TERMINO" UniqueName="FE_TERMINO"  DataType="System.DateTime"></telerik:GridDateTimeColumn>
                                            ...
                                            <telerik:GridDateTimeColumn DataFormatString="{0:d}" AutoPostBackOnFilter="true"  Visible="true" Display="true" HeaderStyle-Width="150" FilterControlWidth="80" HeaderText="Fecha de envío" DataField="FE_ENVIO_CORREO" UniqueName="FE_ENVIO_CORREO" DataType="System.DateTime"></telerik:GridDateTimeColumn>
                                ...
                                <telerik:RadGrid
                                    ...
                                    <MasterTableView ClientDataKeyNames="ID_BATERIA,M_EMPLEADO_ID_EMPLEADO, ID_CANDIDATO, ID_SOLICITUD, ESTATUS" Name="Baterias"
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="true" HeaderStyle-Width="150" FilterControlWidth="80" HeaderText="Estatus batería" DataField="ESTATUS" UniqueName="ESTATUS"></telerik:GridBoundColumn>
                                            <telerik:GridDateTimeColumn DataFormatString="{0:d}" AutoPostBackOnFilter="true"  Visible="true" Display="true" HeaderStyle-Width="150" FilterControlWidth="80" HeaderText="Fecha de aplicación" DataField="FE_TERMINO" UniqueName="FE_TERMINO"></telerik:GridDateTimeColumn>
                                            ...
                                            <telerik:GridDateTimeColumn DataFormatString="{0:d}" AutoPostBackOnFilter="true"  Visible="true" Display="true" HeaderStyle-Width="150" FilterControlWidth="80" HeaderText="Fecha de envío" DataField="FE_ENVIO_CORREO" UniqueName="FE_ENVIO_CORREO"></telerik:GridDateTimeColumn>
