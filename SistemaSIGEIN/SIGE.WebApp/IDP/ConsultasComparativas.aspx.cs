    ...
    public partial class ConsultasComparativas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                ContextoConsultasComparativas.oPuestoVsCandidatos.Add(new E_PUESTO_VS_CANDIDATOS { vIdPuestoVsCandidatos = vIdPuestoVsCandidatos });
                ContextoConsultasComparativas.oCandidatoVsPuestos.Add(new E_CANDIDATO_VS_PUESTOS { vIdCandidatoVsPuestos = vIdCandidatoVsPuestos });
            }
        }
