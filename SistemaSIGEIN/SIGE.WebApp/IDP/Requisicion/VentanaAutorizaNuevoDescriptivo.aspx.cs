...
{
    public partial class VentanaAutorizaNuevoDescriptivo : System.Web.UI.Page
    {
        #region Varianbles
        ...
        private void GuardarEnviar(string pClEstatusPuesto)
        {
            ...
            //var autoriza = "S";
            var vClEstatusPuesto = pClEstatusPuesto == "AUTORIZADO" ? "A" : "R";
            string vMensajeCorreo = "";
            var vNbCorreo = "";
            var nbCreaRequisicion = "";
            var vDsComentarios = radEditorAutorizar.Text;

            if (pClEstatusPuesto == "RECHAZADO" & radEditorAutorizar.Text == "")
            {
                UtilMensajes.MensajeResultadoDB(rwmAlertas, "Indica el motivo del rechazo del descriptivo de puesto", E_TIPO_RESPUESTA_DB.ERROR, pCallBackFunction: "");
                return;
            }
            ...
            //{
            //    vPuesto.ID_PUESTO = vRequisicion.ID_PUESTO;
            //}
            //else
            //{
            //    vPuesto.ID_PUESTO = vIdDescriptivo;
            ...
            try
            {
                ...
                if (pClEstatusPuesto.Equals("RECHAZADO"))
                {
                ...
                E_RESULTADO vResultado = neg.InsertaActualizaPuestoRequsicion("A",vIdDescriptivo.Value,"","", vidRequisicion.Value, vDsComentarios, "S", vClEstatusPuesto, vClUsuario, vNbPrograma);
                ...
                {
                    UtilMensajes.MensajeResultadoDB(rwmAlertas, vMensaje, E_TIPO_RESPUESTA_DB.WARNING);
                }
            }
            catch (Exception)
            {
        ...
        protected void btnAutorizar_Click(object sender, EventArgs e)
        {
            ...
            //    if (correo != "")
            //    {
            //        if (vRequisicion.CL_ESTATUS == "EN REVISION")
            //        {
            //        }
            //        else
            //        {
            //            UtilMensajes.MensajeResultadoDB(rwmAlertas, "Este puesto ya está " + vRequisicion.CL_ESTATUS, E_TIPO_RESPUESTA_DB.WARNING, pCallBackFunction: "");
            //        }
            //    }
            //    else
            //    {
