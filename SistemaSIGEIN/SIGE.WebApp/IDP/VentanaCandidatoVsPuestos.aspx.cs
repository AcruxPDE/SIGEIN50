...
{
    public partial class VentanaCandidatoVsPuestos : System.Web.UI.Page
    {
        ...
        protected void GraficaCandidatoPuestos(List<E_GRAFICA_PUESTO_CANDIDATOS> plstCandidatoPuestos)
        {
            ...
            foreach (var item in vListaPuestos)
            {
                ...
                if (continua)
                {
                    ...
                    //rhcCandidatoPuestos.PlotArea.Series.Add(vPuestos);
                    continua = false;
                }
            }
        ...
        class E_GRAPHIC_PUESTO_DATOS
        {
            ...
            public List<E_GRAPHIC_PUESTOS> Datos { get; set; }
        }

        [Serializable]
        class E_GRAPHIC_PUESTOS
        {
            public string Puesto { get; set; }
