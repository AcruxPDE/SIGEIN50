<%@ Page Title="" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="VentanaImprimirSolicitud.aspx.cs" Inherits="SIGE.WebApp.Administracion.VentanaImprimirSolicitud" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    <div id="dvImprimir" runat="server" style="width: 790px; padding-top: 10px; padding-bottom: 10px; padding-left: 10px; padding-right: 10px;">
        ...
        <div id="pvwPersonal" runat="server">
            <label style="display: block !important; width: 100% !important; padding: 0 !important; margin-bottom: 20px !important; font-size: 21px !important; line-height: inherit !important; border: 0 !important; border-bottom: 1px solid #C6DB95 !important;">Información personal</label>
        ...
        <div id="pvwFamiliar" runat="server">
            <label style="display: block !important; width: 100% !important; padding: 0 !important; margin-bottom: 20px !important; font-size: 21px !important; line-height: inherit !important; border: 0 !important; border-bottom: 1px solid #C6DB95 !important;">Información familiar</label>
        </div>
        <div style="clear: both; height: 15px"></div>
        <div id="pvwAcademica" runat="server">
            <label style="display: block !important; width: 100% !important; padding: 0 !important; margin-bottom: 20px !important; font-size: 21px !important; line-height: inherit !important; border: 0 !important; border-bottom: 1px solid #C6DB95 !important;">Información académica</label>
        </div>
        <div style="clear: both; height: 15px"></div>
        <div id="pvwLaboral" runat="server">
            <label style="display: block !important; width: 100% !important; padding: 0 !important; margin-bottom: 20px !important; font-size: 21px !important; line-height: inherit !important; border: 0 !important; border-bottom: 1px solid #C6DB95 !important;">Información laboral</label>
        </div>
        <div style="clear: both; height: 15px"></div>
        <div id="pvwCompetencias" runat="server">
            <label style="display: block !important; width: 100% !important; padding: 0 !important; margin-bottom: 20px !important; font-size: 21px !important; line-height: inherit !important; border: 0 !important; border-bottom: 1px solid #C6DB95 !important;">Intereses y competencias</label>
        </div>
        <div style="clear: both; height: 15px"></div>
        <div id="pvwAdicional" runat="server">
            <label style="display: block !important; width: 100% !important; padding: 0 !important; margin-bottom: 20px !important; font-size: 21px !important; line-height: inherit !important; border: 0 !important; border-bottom: 1px solid #C6DB95 !important;">Información adicional</label>
        </div>
        <div style="clear: both; height: 15px"></div>
        <div id="pvwDocumentos" runat="server">
            <label style="display: block !important; width: 100% !important; padding: 0 !important; margin-bottom: 20px !important; font-size: 21px !important; line-height: inherit !important; border: 0 !important; border-bottom: 1px solid #C6DB95 !important;">Documentación</label>
