...
{
    public partial class GraficaAnalisisDesviaciones : System.Web.UI.Page
    {
        ...
        {
            int dataKey = 0;
            if (Request.QueryString["pIdTabuladoNivel"] != null)
                dataKey = int.Parse(Request.QueryString["pIdTabuladoNivel"].ToString());
