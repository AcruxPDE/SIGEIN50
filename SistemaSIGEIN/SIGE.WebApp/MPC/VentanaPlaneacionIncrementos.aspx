<%@ Page Title="" Language="C#" MasterPageFile="~/MPC/ContextMC.master" AutoEventWireup="true" CodeBehind="VentanaPlaneacionIncrementos.aspx.cs" Inherits="SIGE.WebApp.MPC.VentanaPlaneacionIncrementos" %>
...
<%--                                        <telerik:GridTemplateColumn AutoPostBackOnFilter="true" ReadOnly="true" HeaderStyle-Width="110" FilterControlWidth="30" HeaderText="Mínimo" DataField="MN_MINIMO_CUARTIL" UniqueName="MN_MINIMO_CUARTIL" ItemStyle-HorizontalAlign="Right">
                                       ...
                                       <span style="border: 1px solid gray; background: <%# Eval("COLOR_DIFERENCIA") %>; border-radius: 5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>&nbsp;
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="TAB_MEDIO" Visible="true" ItemStyle-HorizontalAlign="Center" ColumnGroupName="TABMEDIO" AllowFiltering="false">
                                            <ItemTemplate>
                                                <div style="text-align: right; font-weight: bold;" id="dvTabulador" runat="server"></div>
                                            </ItemTemplate>
                                        </telerik:GridTemplateColumn>
