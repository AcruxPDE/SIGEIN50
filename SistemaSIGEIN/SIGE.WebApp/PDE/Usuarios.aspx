...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnAgregar">
                <UpdatedControls> 
                    ...
                    <telerik:AjaxUpdatedControl ControlID="btnAgregar" UpdatePanelHeight="100%" />
                </UpdatedControls>
            </telerik:AjaxSetting>
    ...
    <div class="divControlDerecha">
        <div class="ctrlBasico">
            <telerik:RadButton ID="btnCargaMasiva" runat="server" name="btnCargaMasiva" AutoPostBack="true" Text="Creación masiva"></telerik:RadButton>
        </div>
    </div>
    ...
    <telerik:RadWindowManager ID="rwmAlertas" runat="server" OnClientClose="returnDataToParentPopup">
        <Windows>
            ...
            <telerik:RadWindow ID="winUsuarios2" runat="server" Title="Agregar/Editar Usuarios" Height="480px" Width="900px" ReloadOnShow="true" VisibleStatusbar="false"
