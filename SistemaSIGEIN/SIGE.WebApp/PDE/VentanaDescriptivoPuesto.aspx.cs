...
namespace SIGE.WebApp.PDE
{
    public partial class VentanaDescriptivoPuesto : System.Web.UI.Page
    {
        ...
        public string vIdEmpleadoVS
        {
            get { return (string)ViewState["vs_IdEmpleadoVS"]; }
            set { ViewState["vs_IdEmpleadoVS"] = value; }
        }
        public int? vIdCambioVS
        {
            get { return (int?)ViewState["vs_IdCambioVS"]; }
            set { ViewState["vs_IdCambioVS"] = value; }
        }
        public string vIdDescriptivoVS
        {
            get { return (string)ViewState["vs_vsvIdDescriptivoVS"]; }
            set { ViewState["vs_vsvIdDescriptivoVS"] = value; }
        }

        public string vsDsCambioVS
        {
            get { return (string)ViewState["vs_vsDsCambioVS"]; }
            set { ViewState["vs_vsDsCambioVS"] = value; }
        }
        string vCambio
        {
        ...
        public string vsDsCambio
        {
            get { return (string)ViewState["vs_vsDsCambio"]; }
            set { ViewState["vs_vsDsCambio"] = value; }
        }
        ...
        {
            get { return (string)ViewState["vs_vIdDescriptivo"]; }
            set { ViewState["vs_vIdDescriptivo"] = value; }
        }

        public int? vIdCambio
        {
            get { return (int?)ViewState["vs_vIdCambio"]; }
            set { ViewState["vs_vIdCambio"] = value; }
        }
        private int? vIdCambioInsertar
        {
            get { return (int?)ViewState["vs_vIdCambioInsertar"]; }
            set { ViewState["vs_vIdCambioInsertar"] = value; }
        }
        ...
        public string vBotonesVisiblesRH
        {
            set { ViewState["vs_vrn_BotonesVisiblesRH"] = value; }
            get { return (string)ViewState["vs_vrn_BotonesVisiblesRH"]; }
        }
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            vBotonesVisiblesRH = (Request.Params["pBotonesVisbles"]);
            if (!Page.IsPostBack)
            {
                if (Request.Params["pIdPuesto"] != null)
                {
                    vIdEmpleado = Request.Params["pIdEmpleado"];
                    vIdDescriptivo = Request.Params["pIdPuesto"];
                ...
                {
                    vIdDescriptivo = (ContextoUsuario.oUsuario.ID_PUESTO_PDE != "0") ? ContextoUsuario.oUsuario.ID_PUESTO_PDE : "-1";
                ...
                if ((vsDsCambio == "Autorizada" && vsTipoConsulta == "e") || (vsDsCambio == "Autorizada" && vsTipoConsulta == "v"))
                {
                    btnGuardar.Visible = false;
                    btnTerminar.Visible = false;
                    btnCancelar.Visible = false;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (adiministrador == false)
                {
                    vNbPrograma = ContextoUsuario.nbPrograma;
                    vClUsuario = ContextoUsuario.oUsuario.CL_USUARIO;
                    vIdDescriptivo = ContextoUsuario.oUsuario.ID_PUESTO_PDE;
                    vIdEmpleado = ContextoUsuario.oUsuario.ID_EMPLEADO_PDE;
                    DescriptivoPuestoNegocio neg = new DescriptivoPuestoNegocio();
                    E_RESULTADO vResultado = neg.ObtieneValidacionCambioDescriptivo(vIdDescriptivo.ToString(), vIdEmpleado, vClUsuario, vNbPrograma);
                    vIdCambio = Int32.Parse(vResultado.MENSAJE.Where(w => w.CL_IDIOMA.Equals("CB")).FirstOrDefault().DS_MENSAJE);


                    if (vIdCambio == -1 && vTipoConsulta == "e")
                    {
                        lblRechazo.Visible = false;
                        principal.Visible = true;
                        copia.Visible = true;
                    }
                    else if (vIdCambio == -1 && vTipoConsulta == "v")
                    {
                        lblRechazo.Visible = false;
                        principal.Visible = false;
                        copia.Visible = false;
                        CargarDatosOriginal(vIdDescriptivo);
                        ObtenerCatalogos();
                    ...
                    else if (vIdCambio != -1 && vTipoConsulta == "v" || vIdCambio != -1 && vTipoConsulta == "e")
                    {
                        lblRechazo.Visible = false;
                        principal.Visible = false;
                        copia.Visible = false;
                        CargarDatos(vIdDescriptivo, vIdCambio, vIdEmpleado);
                        ObtenerCatalogos();
                        dgvCompetencias.DataSource = vListaCompetencias.Where(n => n.CL_TIPO_COMPETENCIA != "ESP");
                        dgvCompetencias.Rebind();
                        grdFuncionesGenericas.Rebind();
                ...
                vsDsCambioVS = vsDsCambio;
                vIdEmpleadoVS = vIdEmpleado;
                vIdCambioVS = vIdCambio;
                vIdDescriptivoVS = vIdDescriptivo;
            }
     
            winFuncionesGenericas.VisibleOnPageLoad = false;
            vClUsuario = ContextoUsuario.oUsuario.NB_USUARIO;
            vNbPrograma = ContextoUsuario.nbPrograma;
            lblRechazo.InnerText = vsDsCambioVS;
        }

        public void CargarDatos(string pIdDescriptivo, int? pIdCambio, string pIdEmpleado)
        {
            DescriptivoPuestoNegocio nDescriptivo = new DescriptivoPuestoNegocio();
            E_DESCRIPTIVO_PDE vDescriptivo = nDescriptivo.ObtieneDescriptivo(pIdDescriptivo, pIdCambio, pIdEmpleado);
            ...
            if (pIdDescriptivo != null)
            {
                ...
                if (vDescriptivo.XML_PRESTACIONES != null)
                {
        ...
        public void CargarDatosOriginal(string pIdDescriptivo)
        {
            DescriptivoNegocio nDescriptivo = new DescriptivoNegocio();
            E_DESCRIPTIVO vDescriptivo = nDescriptivo.ObtieneDescriptivo_pde(pIdDescriptivo);
            vListaEscoloridad = vDescriptivo.LST_ESCOLARIDADES;
            vListaGenero = vDescriptivo.LST_CATALOGO_GENERO;
            vListaEdoCivil = vDescriptivo.LST_CATALOGO_EDOCIVIL;
            vListaCompetencias = vDescriptivo.LST_CATALOGO_COMPETENCIAS_ESP;
            ...
            if (pIdDescriptivo != null)
            {
                txtNombreCorto.Text = vDescriptivo.CL_PUESTO;
                txtDescripcionPuesto.Text = vDescriptivo.NB_PUESTO;
                if ((double?)vDescriptivo.NO_PLAZAS > 0)
                {
                    txtNoPlazas.Value = (double?)vDescriptivo.NO_PLAZAS;
                }
        ...
        public string generarXml(XElement pXmlAdicionales)
        {
            ...
            XElement pDescriptivo = new XElement("DESCRIPTIVO",
                ...
                EditorContentToXml("XML_PRESTACIONES", radEditorPrestaciones.Content.Replace("&lt;",""), vNbFirstRadEditorTagName),
                EditorContentToXml("XML_REQUERIMIENTOS", radEditorRequerimientos.Content.Replace("&lt;", ""), vNbFirstRadEditorTagName),
                EditorContentToXml("XML_OBSERVACIONES", radEditorObservaciones.Content.Replace("&lt;", ""), vNbFirstRadEditorTagName),
                EditorContentToXml("XML_RESPONSABILIDAD", radEditorResponsable.Content.Replace("&lt;", ""), vNbFirstRadEditorTagName),
                EditorContentToXml("XML_AUTORIDAD", radEditorAutoridad.Content.Replace("&lt;", ""), vNbFirstRadEditorTagName),
        ...
        public void GuardarPuesto(bool pFgCerrarVentana)
        {
            if (validarControles())
            {
                ...
                if (vXmlCA != null)
                {
                    ...
                    {
                        tran = "A";
                        vPuesto.ID_PUESTO = int.Parse(vIdDescriptivoVS);
                    }

                    if (vIdCambio != -1)
                    {
                      vIdDescriptivo = vIdDescriptivoVS;
                      vIdCambioInsertar = vIdCambioVS;
                    }
                        E_RESULTADO vResultado = neg.InsertaActualizaDescriptivo(vIdDescriptivo, vIdCambioInsertar, vClUsuario, vNbPrograma, tran, vPuesto);
                    ...
                    if (vResultado.CL_TIPO_ERROR.Equals(E_TIPO_RESPUESTA_DB.SUCCESSFUL) && tran.Equals("I"))
                    {
                        ...
                        vIdDescriptivo = UtilXML.ValorAtributo<string>(vPuestoInsertado.Attribute("ID_PUESTO"));
                    }
        ...
        protected void dgvCompetencias_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            {
                dgvCompetencias.DataSource = new List<E_COMPETENCIAS>();// vListaCompetencias.Where(n => n.CL_TIPO_COMPETENCIA != "ESP");}
            }
        }
        ...
        protected void btnAceptar_Click(object sender, EventArgs e)
        {
            ...
            if (vIdCambio != -1)
            {
                E_RESULTADO vResultado = neg.InsertaActualizaCopiaDescriptivo(vIdDescriptivoVS, vClUsuario, vNbPrograma, vIdEmpleadoVS);
                vIdCambioInsertar = Int32.Parse(vResultado.MENSAJE.Where(w => w.CL_IDIOMA.Equals("CB")).FirstOrDefault().DS_MENSAJE);
            }
            else
            {
                E_RESULTADO vResultado = neg.InsertaActualizaCopiaDescriptivo(vIdDescriptivoVS, vClUsuario, vNbPrograma, vIdEmpleado);
                vIdCambioInsertar = Int32.Parse(vResultado.MENSAJE.Where(w => w.CL_IDIOMA.Equals("CB")).FirstOrDefault().DS_MENSAJE);

            }
            principal.Visible = false;
            copia.Visible = false;
            CargarDatos(vIdDescriptivo, vIdCambioInsertar, vIdEmpleado);
            ObtenerCatalogos();
            dgvCompetencias.DataSource = vListaCompetencias.Where(n => n.CL_TIPO_COMPETENCIA != "ESP");
            dgvCompetencias.Rebind();
            grdFuncionesGenericas.Rebind();
        ...
        {
            DescriptivoPuestoNegocio nego = new DescriptivoPuestoNegocio();
            if (vIdCambio != -1)
            {
                E_RESULTADO vResultado = nego.EliminaDescriptivoPuesto(vIdDescriptivoVS, vClUsuario, vNbPrograma, vIdEmpleado, vIdCambio);
                vIdCambio = Int32.Parse(vResultado.MENSAJE.Where(w => w.CL_IDIOMA.Equals("CB")).FirstOrDefault().DS_MENSAJE);
            }
            else
            {
                E_RESULTADO vResultado = nego.EliminaDescriptivoPuesto(vIdDescriptivo, vClUsuario, vNbPrograma, vIdEmpleado, vIdCambioInsertar);
                vIdCambio = Int32.Parse(vResultado.MENSAJE.Where(w => w.CL_IDIOMA.Equals("CB")).FirstOrDefault().DS_MENSAJE);
        ...
        protected void btnTerminar_Click(object sender, EventArgs e)
        {
            ...
            if (vIdCambio != -1)
            {
                ...
                E_RESULTADO vResultado = neg.FinalizaModificacionDescriptivo(vIdDescriptivoVS, vClUsuario, vNbPrograma, vIdEmpleadoVS);
                string vMensaje = vResultado.MENSAJE.Where(w => w.CL_IDIOMA.Equals(vClIdioma.ToString())).FirstOrDefault().DS_MENSAJE;
                UtilMensajes.MensajeResultadoDB(rwmAlertas, vMensaje, E_TIPO_RESPUESTA_DB.SUCCESSFUL);
            }
            else
            {
                E_RESULTADO vResultado2 = neg.FinalizaModificacionDescriptivo(vIdDescriptivoVS, vClUsuario, vNbPrograma, vIdEmpleado);
                string vMensaje = vResultado2.MENSAJE.Where(w => w.CL_IDIOMA.Equals(vClIdioma.ToString())).FirstOrDefault().DS_MENSAJE;
                UtilMensajes.MensajeResultadoDB(rwmAlertas, vMensaje, E_TIPO_RESPUESTA_DB.SUCCESSFUL);
            }
        }
        ...
        protected void btnAutorizar_Click(object sender, EventArgs e)
        {
            ...
            {
                DescriptivoPuestoNegocio neg = new DescriptivoPuestoNegocio();
                E_RESULTADO vResultado = neg.InsertaActualizaDescriptivo(vIdDescriptivoVS, vClUsuario, vNbPrograma, vIdCambioVS, true, "Autorizada", "Autorizada");
                string vMensaje = vResultado.MENSAJE.Where(w => w.CL_IDIOMA.Equals(vClIdioma.ToString())).FirstOrDefault().DS_MENSAJE;
                UtilMensajes.MensajeResultadoDB(rwmAlertas, vMensaje, E_TIPO_RESPUESTA_DB.SUCCESSFUL);
