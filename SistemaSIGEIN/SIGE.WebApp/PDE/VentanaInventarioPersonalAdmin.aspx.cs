...
{
    public partial class VentanaInventarioPersonalAdmin : System.Web.UI.Page
    {
        ...
        E_RESULTADO vResultado = inventario.Actualiza_Informacion_Original_de_Empleado(vIdEmpleadoVS.ToString(), vClUsuario, vNbPrograma, vIdCambioVS, true, "Autorizada", "Autorizada");
                             string vMensaje = vResultado.MENSAJE.Where(w => w.CL_IDIOMA.Equals(vClIdioma.ToString())).FirstOrDefault().DS_MENSAJE;
                             UtilMensajes.MensajeResultadoDB(rnMensajeR, vMensaje, E_TIPO_RESPUESTA_DB.SUCCESSFUL);
