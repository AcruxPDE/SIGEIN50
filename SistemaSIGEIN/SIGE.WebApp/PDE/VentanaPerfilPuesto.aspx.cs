...
{
    public partial class VentanaPerfilPuesto : System.Web.UI.Page
    {
        ...
        private XElement SELECCIONUSUARIOS { get; set; }
            ...
            protected void btnGuardar_Click(object sender, EventArgs e)
            {
                ...
                string vUrls = WebUtility.HtmlEncode("Estimado(a):" +vUsuario.NB_USUARIO +
                                    "Cambio su contraseña para acceder a Punto de encuentro:" +
                                    "  Usuario: " + vUsuario.CL_USUARIO + " Contraseña: " + vUsuario.CONTRASENA +
                                   "En caso de no haber realizado ese cambio, favor de notificar al administrador. Saludos.");
