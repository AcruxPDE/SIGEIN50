...
{
    public partial class VenatanaRoles_PDE : System.Web.UI.Page
    {
        ...
        {
            grdMenuModulos.DataSource = vLstFunciones.Where(w => w.CL_TIPO_FUNCION.Equals(E_TIPO_FUNCION.MENUWEB.ToString()));
        }

        protected void grdMenuGeneral_NeedDataSource(object sender, TreeListNeedDataSourceEventArgs e)
        {
            grdMenuGeneral.DataSource = vLstFunciones.Where(w => w.CL_TIPO_FUNCION.Equals(E_TIPO_FUNCION.MENUGRAL.ToString()));
        }
