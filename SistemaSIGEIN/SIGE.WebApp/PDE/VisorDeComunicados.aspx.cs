...
{
    public partial class VisorDeComunicados : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                if (Request.Params["IdComunicado"] != null)
                {
                    ...
                    ListaComunicados = negocio.ObtenerComunicados(null, ContextoUsuario.oUsuario.CL_USUARIO);
        ...
        protected void rcbleido_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                E_RESULTADO res = negocio.ActualizarComunicadoNoLeido(datakey, (ContextoUsuario.oUsuario.CL_USUARIO), vClUsuario, vNbPrograma);
            ...
            {
                E_RESULTADO res = negocio.ActualizarComunicadoLeido(datakey, (ContextoUsuario.oUsuario.CL_USUARIO), vClUsuario, vNbPrograma);
