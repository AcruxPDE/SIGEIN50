<%@ Page Title="" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="VentanaOcupacionModulo.aspx.cs" Inherits="SIGE.WebApp.STPS.VentanaOcupacionModulo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <div class="ctrlBasico">
        <div class="divControlIzquierda">
            <label id="lblClave" name="lblClave" runat="server">Clave de módulo:</label>
        </div>
        <div class="divControlDerecha">
    ...
    <div class="ctrlBasico">
        <div class="divControlIzquierda">
            <label id="lblModulo" name="lblModulo" runat="server">Nombre del módulo:</label>
        </div>
        <div class="divControlDerecha">
            <telerik:RadTextBox ID="txtModulo" runat="server" Width="300px" MaxLength="200"></telerik:RadTextBox><br />
            <asp:RegularExpressionValidator Display="Dynamic" ID="RegularExpressionValidator2" runat="server"
                ControlToValidate="txtModulo" ErrorMessage="Sólo se permiten: letras, números, coma(,), punto(,) y guión(-)"
                ForeColor="Red" CssClass="validacion" Font-Size="Smaller"
    ...
    <div class="divControlDerecha">
        <div class="ctrlBasico">
            <telerik:RadButton ID="btnGuardarModulo" runat="server" Width="100px" Text="Guardar" OnClick="btnGuardarModulo_Click" AutoPostBack="true"></telerik:RadButton>
            <telerik:RadButton ID="btnCancelarModulo" runat="server" Width="100px" Text="Cancelar" AutoPostBack="false" OnClientClicking="closeWindow"></telerik:RadButton>
        </div>
    </div>
