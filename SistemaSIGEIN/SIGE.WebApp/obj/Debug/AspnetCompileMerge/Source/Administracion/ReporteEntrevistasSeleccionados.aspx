        ...
        <telerik:RadGrid ID="grdEntrevistas" runat="server" Height="100%" HeaderStyle-Font-Bold="true" AutoGenerateColumns="false" ShowGroupPanel="True" AllowPaging="true" AllowSorting="true" AllowFilteringByColumn="true"
            ...
            <MasterTableView EnableColumnsViewState="false" AllowPaging="true" AllowFilteringByColumn="true"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderText="Período profesional" DataField="PERIODO_PROFESIONAL" UniqueName="PERIODO_PROFESIONAL" HeaderStyle-Width="240" FilterControlWidth="50"></telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderText="Período postgrado" DataField="PERIODO_POSTGRADO" UniqueName="PERIODO_POSTGRADO" HeaderStyle-Width="240" FilterControlWidth="50"></telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderText="Período actual"  DataField="PERIODO_ACTUAL" UniqueName="PERIODO_ACTUAL" HeaderStyle-Width="240" FilterControlWidth="50"></telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderText="Período anterior 1" DataField="PERIODO_ANTERIOR1" UniqueName="PERIODO_ANTERIOR1" HeaderStyle-Width="240" FilterControlWidth="50"></telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderText="Período anterior 2" DataField="PERIODO_ANTERIOR2" UniqueName="PERIODO_ANTERIOR2" HeaderStyle-Width="240" FilterControlWidth="50"></telerik:GridBoundColumn>
