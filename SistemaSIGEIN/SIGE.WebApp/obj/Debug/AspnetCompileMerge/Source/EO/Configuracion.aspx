    ...
    <div style="height: calc(100% - 90px);">
        ...
        <telerik:RadTabStrip ID="rtsConfiguracion" runat="server" SelectedIndex="0" MultiPageID="rmpConfiguracion">
            <Tabs>
                ...
                <telerik:RadTab Text="Recepción de mensajes"></telerik:RadTab>
                <%--<telerik:RadTab Text="Notificaciones de baja de capturista"></telerik:RadTab>--%>
                <telerik:RadTab Text="Notificaciones de baja de notificado"></telerik:RadTab>
            ...
            <telerik:RadMultiPage ID="rmpConfiguracion" runat="server" SelectedIndex="0" Height="100%">
                            ...
                            <telerik:RadSlidingZone ID="rszAyuda" runat="server" Width="30" ClickToOpen="true" SlideDirection="Left">
                                <telerik:RadSlidingPane ID="rspAyuda" runat="server" Title="Captura de mensaje" Width="500" MinWidth="500" Height="100%">
                                    <div style="padding: 10px;">
                                        ...
                                        <telerik:RadEditor Height="700" Width="100%" ToolsWidth="500" EditModes="Design" ID="txtMensajeCaptura" runat="server" ToolbarMode="ShowOnFocus" ToolsFile="~/Assets/AdvancedTools.xml"></telerik:RadEditor>
                                    </div>
                ...
                <telerik:RadPageView ID="rpvRecepcionMensajes" runat="server">
                    ...
                    <telerik:RadSplitter ID="rsRecepcionMensajes" runat="server" Width="100%" Height="100%" BorderSize="0">
                        ...
                        <telerik:RadPane ID="rpMensajeImportantes" runat="server">
                            <div style="height: calc(100% - 100px);">
                                <telerik:RadGrid ID="grdRecepcionMensajes" runat="server" HeaderStyle-Font-Bold="true" OnNeedDataSource="grdRecepcionMensajes_NeedDataSource" AutoGenerateColumns="false" Height="100%" AllowMultiRowSelection="true" OnItemDataBound="grdRecepcionMensajes_ItemDataBound">
                                    <ClientSettings>
                                        <Scrolling AllowScroll="true" UseStaticHeaders="true" />
                                        <Selecting AllowRowSelect="true" />
                                    </ClientSettings>
                            ...
                            <div class="ctrlBasico">
                                <telerik:RadButton runat="server" ID="btnAgregarImportante" Text="Agregar empleados" AutoPostBack="false" OnClientClicked="OpenSelectionMensajesImportantesWindow"></telerik:RadButton>
                            </div>
                            <div class="ctrlBasico">
                                <telerik:RadButton runat="server" ID="btnEliminarImportante" Text="Eliminar empleados" OnClick="btnEliminarImportante_Click"></telerik:RadButton>
                            </div>
                        </telerik:RadPane>
                ...
                <telerik:RadPageView ID="rpvBajaNotificado" runat="server">
                    ...
                    <telerik:RadSplitter ID="rsBajaNotificado" runat="server" Width="100%" Height="100%" BorderSize="0">
                        ...
                        <telerik:RadPane ID="rpGridBajaNotificado" runat="server">
                            ...
                            <div style="height: calc(100% - 100px); ">
                                <telerik:RadGrid ID="grdBajaNotificado" runat="server" HeaderStyle-Font-Bold="true" OnNeedDataSource="grdBajaNotificado_NeedDataSource" AutoGenerateColumns="false" Height="100%" AllowMultiRowSelection="true" OnItemDataBound="grdBajaNotificado_ItemDataBound">
                                    <ClientSettings>
                                        <Scrolling AllowScroll="true" UseStaticHeaders="true" />
                                        <Selecting AllowRowSelect="true" />
                                    </ClientSettings>
                            ...
                            <div style="clear: both; height: 5px"></div>
                            <div class="ctrlBasico">
                                <telerik:RadButton runat="server" ID="btnAltaEmpleadoBajaNotificado" Text="Agregar empleados" AutoPostBack="false" OnClientClicked="OpenSelectionEmpleadosBajaNotificadoWindow"></telerik:RadButton>
                            </div>
                            <div class="ctrlBasico">
                                <telerik:RadButton runat="server" ID="btnBajaEmpleadoBajaNotificado" Text="Eliminar empleados" OnClick="btnBajaEmpleadoBajaNotificado_Click"></telerik:RadButton>
                            </div>
                        </telerik:RadPane>
                ...
                <telerik:RadPageView ID="rpvAsignacionBono" runat="server">
                    <div style="overflow-y: scroll; height: calc(100% - 70px); padding-right:10px;">
                        ...
                        <fieldset>
                            <legend><label style="font-weight:bold;">Individual independiente</label></legend>
                            <div style="height: 10px;"></div>
                        ...
                        <fieldset>
                            <legend><label style="font-weight:bold;">Individual dependiente</label></legend>
                            <div style="height: 10px;"></div>
                        ...
                        <fieldset>
                            <legend><label style="font-weight:bold;">Grupal</label></legend>
                            <div style="height: 10px;"></div>
