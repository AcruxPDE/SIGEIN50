<%@ Page Title="" Language="C#" MasterPageFile="~/EO/ContextEO.master" AutoEventWireup="true" CodeBehind="VentanaContextoAdjuntarEvidenciaMetas.aspx.cs" Inherits="SIGE.WebApp.EO.Cuestionarios.VentanaContextoAdjuntarEvidenciaMetas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    <div style="height: calc(100% - 80px);">
        ...
        <table class="ctrlTableForm" id="table" runat="server">
            <tr>
