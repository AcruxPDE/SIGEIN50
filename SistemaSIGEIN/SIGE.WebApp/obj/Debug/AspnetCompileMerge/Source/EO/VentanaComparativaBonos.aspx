<%@ Page Title="" Language="C#" MasterPageFile="~/EO/ContextEO.master" AutoEventWireup="true" CodeBehind="VentanaComparativaBonos.aspx.cs" Inherits="SIGE.WebApp.EO.VentanaComparativaBonos" %>
            ...
            <telerik:RadPageView ID="rpvBonos" runat="server">
                <div style="height: 100%">
                    <telerik:RadGrid
                        ...
                        <PagerStyle AlwaysVisible="true" />
                        <GroupingSettings CaseSensitive="false"  />
                        <MasterTableView   AllowPaging="false" AllowFilteringByColumn="false" ShowHeadersWhenNoRecords="true" EnableHeaderContextFilterMenu="false">
                            <ColumnGroups>
