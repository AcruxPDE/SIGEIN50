<%@ Page Title="" Language="C#" MasterPageFile="~/IDP/ContextIDP.master" AutoEventWireup="true" CodeBehind="VentanaAutorizaNuevoDescriptivo.aspx.cs" Inherits="SIGE.WebApp.IDP.Solicitud.VentanaAutorizaNuevoDescriptivo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <div>
        <table class="ctrlTableForm" style="width: 100%;">
            ...
            <tr>
                <td class="ctrlTableDataBorderContext">
                    <span id="txtRequerimientos" runat="server"></span>
                </td>
            </tr>
            <tr>
                <td class="ctrlTableDataContext">
    ...
    <fieldset style="width: 98%;">
        <legend>
            ...
            <telerik:RadEditor Width="90%" Height="200px" EditModes="Design" ToolbarMode="Default" ID="radEditorAutorizar" runat="server" ToolsFile="~/Assets/AdvancedTools.xml"></telerik:RadEditor>
        </legend>
    </fieldset>

    <div class="divControlDerecha">
        <div class="ctrlBasico">
            <telerik:RadButton runat="server" ID="btnAutorizar" ValidationGroup="ValClave" UseSubmitBehavior="false" Text="Autorizar" OnClick="btnAutorizar_Click"></telerik:RadButton>
        </div>

        <div class="ctrlBasico">
            <telerik:RadButton runat="server" ID="btnRechazar" ValidationGroup="ValComentario" Text="Rechazar" OnClick="btnRechazar_Click"></telerik:RadButton>
        </div>
    </div>
