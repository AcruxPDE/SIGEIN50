...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <div style="height: calc(100% - 35px); padding: 10px 0px 10px 0px;">
        ...
        <div class="ctrlBasico">
            <div class="divControlIzquierda">
                <label id="lblNombre">Título del campo:</label>
            </div>
            <div class="divControlDerecha">
                                ...
                                <telerik:RadSlidingZone ID="rszAyudaCuestionario" runat="server" SlideDirection="Left" Width="22px" >
                                    <telerik:RadSlidingPane ID="rspAyudaCuestionario" RenderMode="Mobile" runat="server" Title="Ayuda" Width="300px">
                                        <div style="text-align: justify; padding: 10px;">
                                            <p>Esta opción permite dar de alta campos abiertos para comentarios, podrás crear tantos cambios como necesites. </p>
                                            <p><strong>Clave:</strong>La clave dela pregunta indica un identificador de la pregunta a crear. <br />
                                               <strong>Título del campo:</strong> Corresponde a el texto que aparecerá como pregunta. <br />
                                              <strong> Tooltip:</strong> Puedes ingresar descripción a la pregunta, esta aparecerá como tooltip. <br />
                                              ...
                                              <strong> Default:</strong> Valor que se mostrara automáticamente al abrir la pregunta. <br />
                                              <strong>  Cuestionario:</strong> Aquí debes de indicar en que cuestionario aparecerá la pregunta a crear, ya sea para autoevaluación, para los evaluadores o para ambos. <br />
                                            </p>
                                        </div>
