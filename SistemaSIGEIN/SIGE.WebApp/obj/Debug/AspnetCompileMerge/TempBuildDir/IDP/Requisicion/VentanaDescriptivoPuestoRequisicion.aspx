<%@ Page Title="" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="VentanaDescriptivoPuestoRequisicion.aspx.cs" Inherits="SIGE.WebApp.IDP.VentanaDescriptivoPuestoRequisicion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <telerik:RadCodeBlock runat="server" ID="radCodeblock">
        <script type="text/javascript">
            ...
            function datosPuesto(pIdPuesto, pNbPuesto, pEstatus) {
                gIdPuesto = pIdPuesto;
                gNbPuesto = pNbPuesto;
                gEstatus = pEstatus;
            ...
            <telerik:RadPane ID="rpnGridEmpleados" runat="server">
                ...
                <telerik:RadTabStrip ID="tbdescriptivospuestos" runat="server" SelectedIndex="0" MultiPageID="mpgdescriptivo">
                    <Tabs>
                        ...
                        <telerik:RadTab Text="Autorizar"></telerik:RadTab>
                    </Tabs>
                </telerik:RadTabStrip>
                    ...
                    <telerik:RadMultiPage ID="mpgdescriptivo" runat="server" SelectedIndex="0" Height="100%" Width="100%">
                        ...
                        <telerik:RadPageView ID="pvwOroganigrama" runat="server">
                          ...
                          <%--  <div class="ctrlBasico">
                            ...
                            <div style="clear: both;"></div>
                            <div>
                                <label class="labelTitulo" id="Label3" name="lblTituloPuestos">
                                    <span style="border: 1px solid gray; background: #FF7400; border-radius: 5px;" title="Formación y desarrollo ">&nbsp;&nbsp;</span>
