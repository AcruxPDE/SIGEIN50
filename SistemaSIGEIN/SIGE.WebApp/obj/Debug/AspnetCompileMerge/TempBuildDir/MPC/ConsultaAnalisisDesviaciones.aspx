            ...
            <telerik:RadPageView ID="rpvDesviaciones" runat="server" Height="100%">
                ...
                <div style="height: calc(100% - 60px); overflow: auto;">
                    <telerik:RadSplitter ID="RadSplitter1" runat="server" Width="100%" Height="100%" BorderSize="0">
                        ...
                        <telerik:RadPane ID="RadPane2" runat="server" Width="20px" Height="90%">
                ...
                <div class="ctrlBasico">
                    ...
                    <telerik:RadSplitter ID="RadSplitter2" runat="server" Width="100%" Height="100%" BorderSize="0">
                        <telerik:RadPane ID="RadPane3" runat="server" Width="100%" Height="100%">
                            <telerik:RadHtmlChart runat="server" ID="PieChartGraficaDesviaciones" Width="100%" Height="98%" Transitions="true" Skin="Silk">
                        ...
                        <telerik:RadPane ID="RadPane4" runat="server" Width="20px" Height="90%">
                            <telerik:RadSlidingZone ID="RadSlidingZone2" runat="server" SlideDirection="Left" Height="100%" ExpandedPaneId="rsConsultas" Width="20px" DockedPaneId="rsbConsultas" ClickToOpen="true">
