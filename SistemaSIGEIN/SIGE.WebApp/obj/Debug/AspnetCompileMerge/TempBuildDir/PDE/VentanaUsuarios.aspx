    ...
    <script id="MyScript" type="text/javascript">
        ...
        function useDataFromChild(pEmpleados) {
            if (pEmpleados != null) {
                ...
                item.set_value(vEmpleadoSeleccionado.idEmpleado_pde);
                items.add(item);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <div style="height: calc(100% - 30px);">
        <telerik:RadTabStrip ID="rtsUsuarios" runat="server" MultiPageID="mpUsuarios">
            <Tabs>
        ...
        <telerik:RadMultiPage ID="mpUsuarios" runat="server" SelectedIndex="0" Height="90%" >
            <telerik:RadPageView ID="rpvUsuario" runat="server" Height="90%">
                <div style="height: calc(100% - 20px);">
                   ...
                   <telerik:RadTextBox ID="id_empleado" name="txtNbUsuario" runat="server" Visible="false" Width="300"></telerik:RadTextBox><br />
                    ...
                    <div class="ctrlBasico">
                        ...
                        <div class="divControlDerecha">
                            <telerik:RadTextBox Visible="false" ID="txtClUsuario" name="txtClUsuario" runat="server"></telerik:RadTextBox><br />
             ...
             <telerik:RadPageView ID="rpvUsuarios" runat="server" Height="100%">
                <div style="height: calc(100% - 20px); padding-left:50px;"">
                <div style="clear: both; height: 10px;" ></div>
                   <telerik:RadGrid 
                       ID="grdEmpleados" 
                       runat="server" 
