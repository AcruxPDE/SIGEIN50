<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.master" AutoEventWireup="true" CodeBehind="ConfiguracionIntegracionNominaDo.aspx.cs" Inherits="SIGE.WebApp.Administracion.ConfiguracionIntegracionNominaDo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="ctrlTableForm" style="width:500px;">
        <tr>
            <td></td>
    ...
    <div style="height: calc(100% - 150px); width:500px; overflow: auto; float:left;">
        <table class="ctrlTableForm" style="width: 100%;">
           ...
           <div class="ctrlBasico" style="height: calc(100% - 10px);">
            <table class="ctrlTableForm" style="width:500px;">
        <tr>
            <td></td>
            <td style="align-content: center;" colspan="2">
    ...
    <div style="height: calc(100% - 150px); width:500px; float:left; padding-left:30px;">
        <table class="ctrlTableForm" style="width: 100%;">
                        <tr>
                <td style="text-align: left; width: 200px;">
