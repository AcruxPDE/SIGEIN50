        ...
        <telerik:RadGrid ID="grdEmpleados" runat="server" Height="100%" Width="100%" HeaderStyle-Font-Bold="true" AutoGenerateColumns="false" ShowGroupPanel="True" AllowPaging="true" AllowSorting="true" AllowFilteringByColumn="true"
            ...
            <MasterTableView   EnableColumnsViewState="false" AllowPaging="true" AllowFilteringByColumn="true"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderText="Centro administrativo" DataField="NB_CENTRO_ADMVO" UniqueName="NB_CENTRO_ADMVO" HeaderStyle-Width="180" FilterControlWidth="110"></telerik:GridBoundColumn>
                    <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderText="Centro operativo" DataField="NB_CENTRO_OPTVO" UniqueName="NB_CENTRO_OPTVO" HeaderStyle-Width="180" FilterControlWidth="110"></telerik:GridBoundColumn>
                    ...
                    <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderText="Teléfono fijo" DataField="TELEFONO_CASA" UniqueName="TELEFONO_CASA" HeaderStyle-Width="150" FilterControlWidth="50"></telerik:GridBoundColumn>
