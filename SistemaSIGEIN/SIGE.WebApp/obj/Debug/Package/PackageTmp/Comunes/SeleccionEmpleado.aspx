<%@ Page Title="" ValidateRequest="false" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="SeleccionEmpleado.aspx.cs" Inherits="SIGE.WebApp.Comunes.SeleccionEmpleado" %>
            ...
            if (selectedItems.length > 0) {
                for (i = 0; i < selectedItems.length; i++) {
                    ...
                    var vEmpleado = {
                        ...
                        idPuesto: selectedItem.getDataKeyValue("M_PUESTO_ID_PUESTO"),
                        clPuesto: masterTable.getCellByColumnUniqueName(selectedItem, "M_PUESTO_CL_PUESTO").innerHTML,
                        nbPuesto: masterTable.getCellByColumnUniqueName(selectedItem, "M_PUESTO_NB_PUESTO").innerHTML,
                        sueldo_ultimo: selectedItem.getDataKeyValue("M_EMPLEADO_MN_SUELDO"),
            ...
            <telerik:RadPane ID="rpnGridEmpleados" runat="server" Height="100%">
                <div style="height: calc(100% - 54px);">
                    <telerik:RadGrid ID="grdEmpleados" HeaderStyle-Font-Bold="true" OnPreRender="grdEmpleados_PreRender" runat="server" Height="100%" AllowMultiRowSelection="true" EnableHeaderContextMenu="true" AllowSorting="true" AutoGenerateColumns="false" OnItemDataBound="grdEmpleados_ItemDataBound">
                        ...
                        <MasterTableView ClientDataKeyNames="M_EMPLEADO_ID_EMPLEADO, M_EMPLEADO_ID_EMPLEADO_PDE, M_EMPLEADO_MN_SUELDO, M_PUESTO_ID_PUESTO" EnableColumnsViewState="false" DataKeyNames="M_EMPLEADO_ID_EMPLEADO , M_EMPLEADO_ID_EMPLEADO_PDE,M_EMPLEADO_MN_SUELDO" AllowPaging="true" AllowFilteringByColumn="true" ShowHeadersWhenNoRecords="true" EnableHeaderContextFilterMenu="true">
                            <Columns>
                ...
                <telerik:RadSlidingZone ID="slzOpciones" runat="server" Width="30" ClickToOpen="true" SlideDirection="Left">
                    <telerik:RadSlidingPane ID="slpAdvSearch" runat="server" Title="Búsqueda avanzada" Width="500" MinWidth="500">
                        <div style="padding: 20px;">
                            <telerik:RadFilter runat="server" ID="ftrGrdEmpleados" FilterContainerID="grdEmpleados" ShowApplyButton="true" ApplyButtonText="Filtrar">
