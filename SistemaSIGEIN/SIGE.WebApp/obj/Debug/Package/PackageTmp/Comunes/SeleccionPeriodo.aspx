<%@ Page Title="" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="SeleccionPeriodo.aspx.cs" Inherits="SIGE.WebApp.Comunes.SeleccionPeriodo" %>
    ...
    <script id="MyScript" type="text/javascript">
        ...
        function addSelection() {
            ...
            if (selectedItems.length > 0) {
                ...
                browserWnd.radalert("Selecciona un período.", 400, 150, "Aviso");
            }
    ...
    <telerik:RadSplitter ID="splPuesto" runat="server" Width="100%" Height="100%" BorderSize="0">
        <telerik:RadPane ID="rpnGridArea" runat="server">
            <div style="height: calc(100% - 54px);">
                <telerik:RadGrid ID="grdPeriodos" HeaderStyle-Font-Bold="true" runat="server" Height="100%" AllowMultiRowSelection="true" OnNeedDataSource="grdPeriodo_NeedDataSource" AutoGenerateColumns="false" EnableHeaderContextMenu="true" ShowGroupPanel="true" AllowSorting="true" OnItemDataBound="grdPeriodos_ItemDataBound">
                    <ClientSettings>
                    ...
                    <MasterTableView ClientDataKeyNames="ID_PERIODO, CL_ESTADO_PERIODO" DataKeyNames="ID_PERIODO, CL_ESTADO_PERIODO" EnableColumnsViewState="false" AllowPaging="true" AllowFilteringByColumn="true" ShowHeadersWhenNoRecords="true" EnableHeaderContextFilterMenu="true">
                        <Columns>
            ...
            <telerik:RadSlidingZone ID="slzBusqueda" runat="server" Width="30" ClickToOpen="true" SlideDirection="Left">
                <telerik:RadSlidingPane ID="slpBusqueda" runat="server" Title="Búsqueda avanzada" Width="500" MinWidth="500">
                    <div style="padding: 20px;">
                        <telerik:RadFilter runat="server" ID="ftrGrdPeriodos" FilterContainerID="grdPeriodos" ShowApplyButton="true" Height="100" ApplyButtonText="Filtrar">
