<%@ Page Title="" Language="C#" MasterPageFile="~/EO/ContextEO.master" AutoEventWireup="true" CodeBehind="VentanaEnvioSolicitudesCuestionario.aspx.cs" Inherits="SIGE.WebApp.EO.VentanaEnvioSolicitudesCuestionario" %>
                    ...
                    <telerik:RadGrid runat="server" ID="rgCorreos" HeaderStyle-Font-Bold="true" AutoGenerateColumns="false" OnNeedDataSource="rgCorreos_NeedDataSource" Height="100%" Width="100%" AllowSorting="true" AllowMultiRowSelection="true">
                        ...
                        <MasterTableView ShowHeadersWhenNoRecords="true" DataKeyNames="ID_EVALUADOR,  FL_EVALUADOR, CL_TOKEN">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn UniqueName="NB_EVALUADOR" DataField="NB_EVALUADOR" HeaderText="Nombre" HeaderStyle-Width="300"></telerik:GridBoundColumn>
