<%@ Page Title="" Language="C#" MasterPageFile="~/FYD/ContextFYD.master" AutoEventWireup="true" CodeBehind="NecesidadesDeCapacitacion.aspx.cs" Inherits="SIGE.WebApp.FYD.NecesidadesDeCapacitacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="headContexto" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidarActualizacionProgramaCapacitacion(sender, args) {
            ...
            var items = vListBox.get_items();
            var vIdPrograma = items[0].get_value();
        ...
        function SeleccionaCompetencia(pChkCompetencia) {
            ...
            for (var i = 3; i < columns.length; i++) {
                ...
                vIdEmpleado = columns[i].get_uniqueName();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <telerik:RadAjaxManager ID="ramNecesidades" runat="server" DefaultLoadingPanelID="ralpNecesidades">
        <AjaxSettings>
    ...
    <telerik:RadSplitter ID="rsPlantilla" Width="100%" Height="100%" BorderSize="0" runat="server">
        <telerik:RadPane ID="rpGridEvaluados" runat="server" Height="100%" ShowContentDuringLoad="false">
            ...
            <div class="ctrlBasico">
                ...
                <telerik:RadButton runat="server" ID="btnbuscaPeriodo" Text="B" Width="35px" AutoPostBack="false"></telerik:RadButton>
                <telerik:RadButton runat="server" ID="btnEliminaPeriodo" Text="X" Width="35px" AutoPostBack="false"></telerik:RadButton>
            </div>
            ...
            <div class="ctrlBasico">
                ...
                <telerik:RadButton runat="server" ID="chkAlta" RenderMode="Lightweight" Text="Alta" ButtonType="ToggleButton" ToggleType="CheckBox" AutoPostBack="false" Checked="true"></telerik:RadButton>
            </div>

            <div class="ctrlBasico">
                <%--<telerik:RadCheckBox runat="server" ID="chkIntermedia" Text="Intermedia" Checked="true" AutoPostBack="false"></telerik:RadCheckBox>--%>
                <telerik:RadButton runat="server" ID="chkIntermedia" RenderMode="Lightweight" Text="Intermedia" ButtonType="ToggleButton" ToggleType="CheckBox" AutoPostBack="false" Checked="true"></telerik:RadButton>
            </div>

            <div class="ctrlBasico">
                <%--<telerik:RadCheckBox runat="server" ID="chkNoNecesaria" Text="No necesaria" Checked="true" AutoPostBack="false"></telerik:RadCheckBox>--%>
                <telerik:RadButton runat="server" ID="chkNoNecesaria" RenderMode="Lightweight" Text="No necesaria" ButtonType="ToggleButton" ToggleType="CheckBox" AutoPostBack="false" Checked="false"></telerik:RadButton>
            </div>
        ...
        <telerik:RadPane ID="rpAyuda" runat="server" Width="22px" ShowContentDuringLoad="false">
            ...
            <telerik:RadSlidingZone ID="rszPrograma" runat="server" SlideDirection="Left" Width="22px">
                ...
                <telerik:RadSlidingPane ID="rspNuevoPrograma" runat="server" Title="Generar programa" Width="340px" RenderMode="Mobile" Height="200">
                    ...
                    <div style="clear: both;"></div>
                    <div class="ctrlBasico">
                        <telerik:RadTextBox runat="server" ID="txtClavePrograma" Width="150px"></telerik:RadTextBox>
                    </div>
                    <div style="clear: both; height: 5px;"></div>
                    <div class="ctrlBasico">
                        <label>Nombre:</label>
                    ...
                    <div style="clear: both;"></div>
                    <div class="ctrlBasico">
                        <telerik:RadTextBox runat="server" ID="txtNombrePrograma" Width="300px"></telerik:RadTextBox>
                    </div>
                    <div style="clear: both; height: 5px;"></div>
                    <div class="ctrlBasico">
                ...
                <telerik:RadSlidingPane ID="rspActualizaPrograma" runat="server" Title="Actualizar programa" Width="315">
                    ...
                    <div class="ctrlBasico">
                        <telerik:RadButton runat="server" ID="btnAgregarPrograma" Text="Agregar" OnClick="btnAgregarPrograma_Click"></telerik:RadButton>
                    </div>
