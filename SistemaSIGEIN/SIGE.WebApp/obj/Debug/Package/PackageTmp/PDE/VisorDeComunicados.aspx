<%@ Page Title="" Language="C#" MasterPageFile="~/PDE/MenuPDE.master" AutoEventWireup="true" CodeBehind="VisorDeComunicados.aspx.cs" Inherits="SIGE.WebApp.PDE.VisorDeComunicados" %>
        ...
        <telerik:RadSplitter ID="RSContenedor" runat="server" Height="100%" Width="100%" BorderSize="0">
            ...
            <telerik:RadPane ID="RPComentarios" runat="server" Width="50%">
                <div style="margin-left: 20px;">
                    ...
                    <telerik:RadLabel runat="server" ID="rlMensajePrivado" Text="No se permiten comentarios en este comunicado porque es privado." Visible="false"></telerik:RadLabel>
