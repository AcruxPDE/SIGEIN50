<%@ Page Title="" Language="C#" MasterPageFile="~/ContextHTML.master" AutoEventWireup="true" CodeBehind="VentanaPlantillaFormulario.aspx.cs" Inherits="SIGE.WebApp.IDP.VentanaPlantillaFormulario" %>
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" OnAjaxRequest="RadAjaxManager1_AjaxRequest">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="RadAjaxManager1">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="txtIdCampo" UpdatePanelHeight="100%" LoadingPanelID="rlpConfiguracion" />
                    <telerik:AjaxUpdatedControl ControlID="txtNbCampo" UpdatePanelHeight="100%" LoadingPanelID="rlpConfiguracion" />
                    <telerik:AjaxUpdatedControl ControlID="txtDsTooltip" UpdatePanelHeight="100%" LoadingPanelID="rlpConfiguracion" />
                    <telerik:AjaxUpdatedControl ControlID="chkHabilitado" UpdatePanelHeight="100%" LoadingPanelID="rlpConfiguracion" />
                    <telerik:AjaxUpdatedControl ControlID="chkRequerido" UpdatePanelHeight="100%" LoadingPanelID="rlpConfiguracion" />
                    <telerik:AjaxUpdatedControl ControlID="btnAplicar" UpdatePanelHeight="100%" LoadingPanelID="rlpConfiguracion" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
            ...
            <telerik:RadPane ID="rpCampos" runat="server">
                <div style="height: calc(100% - 35px);">
                    ...
                    <div style=" clear: both;"></div>
                     <div class="ctrlBasico">
                         <div class="divControlIzquierda" style="width: 150px !important;">
                             <label name="lblTipoExposicion">Exposición</label>
                         </div>
                         <div class="divControlDerecha">
                             <telerik:RadComboBox
                                 Filter="Contains"
                                 runat="server"
                                 Enabled="false"
                                 ID="cmbTipoExposición"
                                 Width="160"
                                 MarkFirstMatch="true"
                                 AutoPostBack="false"
                                 DropDownWidth="120">
                                 <Items>
                                     <telerik:RadComboBoxItem Text="Interior" Value="INTERIOR" />
                                     <telerik:RadComboBoxItem Text="Exterior" Value="EXTERIOR" />
                                 </Items>
                             </telerik:RadComboBox>
                         </div>
                     </div>
