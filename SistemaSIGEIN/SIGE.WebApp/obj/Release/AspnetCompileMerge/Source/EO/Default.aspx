<%@ Page Title="" Language="C#" MasterPageFile="~/EO/MenuEO.master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="SIGE.WebApp.EO.Default" %>
                ...
                <telerik:LayoutRow>
                    <Content>
                        <div style="float: left; padding-left: 20px;">
                            <h3>EVALUACIÓN ORGANIZACIONAL</h3>
                        </div>
                    </Content>
                </telerik:LayoutRow>
                <telerik:LayoutRow>
                    <Content>
                        <div class="col-xs-12 col-lg-6 col-md-6 col-sm-6" style="margin-top: 100px;">
                            <div style="padding-left: 20px;">
                                <h3><b style="color: #A20804;">Bienvenido(a) al sistema</b> </h3>
                                <b><%= vNbUsuario %></b>
                                <br />
                                <br />
                        ...
                        <div class="col-xs-12 col-lg-6 col-md-6 col-sm-6" style="margin-top: 50px;">
                            <div style="position: relative; overflow: hidden;">
                                <img id="imgEvaluacionOrganizacional" src="../Assets/images/menu/EvaluacionOrganizacional600x344.png" class="img-responsive" />
                            </div>
                        </div>
                    </Content>
                </telerik:LayoutRow>
