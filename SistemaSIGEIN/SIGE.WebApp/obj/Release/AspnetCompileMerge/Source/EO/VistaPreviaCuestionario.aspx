...
<%--                <input id="ckMasculino" runat="server" type="checkbox" title="Masculino" />Masculino
                <input id="ckFemenino" runat="server" type="checkbox" title="Femenino" />Femenino--%>
                        </div>

                <%--<input id="txtGeneros" runat="server" type="text" name="txtGeneros" visible="false" readonly="true" style="background-color: #cccccc; border-style: none; border-width: 1px; border-radius: 5px; width: 120px">--%>

 <%--       </div>--%>
         <div style="clear: both; height: 5px;"></div>
        <div class="ctrlBasico">
            <label id="lbDepartamento" name="LbFiltros" runat="server" visible="false" style="width: 100px;">Área:</label>
        </div>
        ...
        <telerik:RadGrid runat="server" ID="rgCuestionario" HeaderStyle-Font-Bold="true" AutoGenerateColumns="false" HeaderStyle-BorderStyle="Solid" HeaderStyle-BorderWidth="1px" Height="100%" Width="100%" OnNeedDataSource="rgCuestionario_NeedDataSource">
            ...
            <MasterTableView ShowHeadersWhenNoRecords="false">
                <Columns>
                    <telerik:GridBoundColumn HeaderText="Secuencia" HeaderStyle-Width="50" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1px" DataField="NO_SECUENCIA" HeaderStyle-Font-Bold="true"></telerik:GridBoundColumn>
                    <telerik:GridBoundColumn HeaderText="Pregunta" DataField="NB_PREGUNTA" HeaderStyle-Width="200" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1px" HeaderStyle-Font-Bold="true"></telerik:GridBoundColumn>
        ...
        <telerik:RadGrid runat="server" ID="rgPreguntasAbiertas" HeaderStyle-Font-Bold="true" AutoGenerateColumns="false" Height="100%" Width="100%" OnNeedDataSource="rgPreguntasAbiertas_NeedDataSource">
            <ClientSettings EnablePostBackOnRowClick="false">
                <Scrolling UseStaticHeaders="true" AllowScroll="false" />
                <Selecting AllowRowSelect="false" />
            </ClientSettings>
            <MasterTableView ShowHeadersWhenNoRecords="false">
                <Columns>
                    <telerik:GridBoundColumn HeaderText="" HeaderStyle-Width="250" HeaderStyle-Height="0" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1px" DataField="NB_PREGUNTA"></telerik:GridBoundColumn>
                    <telerik:GridTemplateColumn HeaderStyle-Width="340" HeaderStyle-Height="0" ItemStyle-BorderStyle="Solid" ItemStyle-BorderWidth="1px" ItemStyle-HorizontalAlign="Center" ReadOnly="true">
                        <ItemTemplate>
                            <telerik:RadTextBox ID="txtRespuesta" runat="server" Height="60" Width="100%" BorderStyle="None" BorderWidth="0"></telerik:RadTextBox>
                        </ItemTemplate>
                    </telerik:GridTemplateColumn>
                </Columns>
            </MasterTableView>
