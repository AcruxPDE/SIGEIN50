...
<asp:Content ID="Content1" ContentPlaceHolderID="headContexto" runat="server">
    <script type="text/javascript">
        ...
        function OpenReporteGlobalWindow() {
            ...
            OpenSelectionWindow("../FYD/ReporteGlobal.aspx?IdReporteGlobal=" + vIdReporteGlobal + "&Fgfoto=" + vFgFoto + "&FgGrid=" + vFgGrid , "rwReporte", "Reporte Global");
        }
        ...
        function OpenReporteComparativoWindow(pIdPeriodo) {
            ...
            OpenSelectionWindow("../FYD/ReporteComparativo.aspx?IdReporteComparativo=" + vIdReporteComparativo + "&Fgfoto=" + vFgFoto, "rwReporte", "Reporte Comparativo");
        }
