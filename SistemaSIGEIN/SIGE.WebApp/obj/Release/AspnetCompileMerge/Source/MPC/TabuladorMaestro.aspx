        ...
        <telerik:RadPageView ID="rpvTabMaestro" runat="server" Height="100%">
            <telerik:RadSplitter ID="rsTabuladorMaestro" BorderSize="0" Width="100%" Height="100%" runat="server">
                ...
                <div class="ctrlBasico">
                            ...
                            <MasterTableView AutoGenerateColumns="false" DataKeyNames="ID_TABULADOR_NIVEL, NO_CATEGORIA, ID_TABULADOR_MAESTRO,ID_ITEM,NO_NIVEL" AllowFilteringByColumn="true" ShowHeadersWhenNoRecords="true">
                                <Columns>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Mínimo" HeaderStyle-Width="150" AutoPostBackOnFilter="false" FilterControlWidth="70" DataField="MN_MINIMO" UniqueName="MN_MINIMO" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox runat="server" ID="txnMinimo" Name="txnMinimo" Width="140px" Text='<%#Eval("MN_MINIMO") %>' MinValue="0" AutoPostBack="true" ShowSpinButtons="true" NumberFormat-DecimalDigits="2" Type="Currency" OnTextChanged="txnMinimo_TextChanged"></telerik:RadNumericTextBox>
                                        </ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn HeaderText="Máximo" HeaderStyle-Width="150" AutoPostBackOnFilter="false" FilterControlWidth="70" DataField="MN_MAXIMO" UniqueName="MN_MAXIMO" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <telerik:RadNumericTextBox runat="server" ID="txnMaximo" Type="Currency" AutoPostBack="true" Name="txnMaximo" Width="140px" Text='<%#Eval("MN_MAXIMO") %>' MinValue="0" ShowSpinButtons="true" NumberFormat-DecimalDigits="2" OnTextChanged="txnMaximo_TextChanged"></telerik:RadNumericTextBox>
                                        </ItemTemplate>
                                    </telerik:GridTemplateColumn>
                    ...
                    <div style="clear: both; height: 10px;"></div>
                    <%--    <div class="ctrlBasico">
        <telerik:RadButton ID="btnMercadoSalarial" AutoPostBack="true" OnClick="btnMercadoSalarialBoton_Click" runat="server" Text="Recalcular tabulador" Width="170"  ToolTip="Generar el tabulador en base a los cambios en el mercado salarial."></telerik:RadButton>
    </div>--%>
                    <div class="ctrlBasico">
