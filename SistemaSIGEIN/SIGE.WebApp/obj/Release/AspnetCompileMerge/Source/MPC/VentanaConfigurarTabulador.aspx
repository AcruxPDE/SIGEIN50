    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            ...
            function OpenSelectionDepartamento() {
                openChildDialog("../Comunes/SeleccionArea.aspx?vClTipoPuesto=<%=vClTipoPuesto%>" + "&vClTipoSeleccion=MC_PUESTO", "winSeleccion", "Selección de áreas")
            }
            ...
            <telerik:RadPageView ID="rpvSeleccionEmpleados" runat="server">
                <telerik:RadSplitter ID="rsSeleccionEmpleados" Width="100%" Height="100%" BorderSize="0" runat="server">
                    <telerik:RadPane ID="rpSeleccionEmpleados" runat="server">
                        ...
                        <div style="clear: both; height: 10px;"></div>
                        <div class="ctrlBasico">
                            <telerik:RadButton ID="btnSeleccionarEmpleados" runat="server" name="btnSeleccionarEmpleados" AutoPostBack="false" Text="Seleccionar" Width="100" OnClientClicked="OpenEmployeeSelectionWindow"></telerik:RadButton>
                        </div>
                        <div class="ctrlBasico">
                            <telerik:RadButton ID="btnSeleccionarPuestos" runat="server" name="btnSeleccionarPuestos" AutoPostBack="false" Text="Seleccionar por puesto" Width="200" OnClientClicked="OpenPuestosSelectionWindow"></telerik:RadButton>
                        </div>
                        <div class="ctrlBasico">
                            <telerik:RadButton ID="btnSeleccionarAreas" runat="server" name="btnSeleccionarAreas" AutoPostBack="false" Text="Seleccionar por área" Width="220" OnClientClicked="OpenSelectionDepartamento"></telerik:RadButton>
                        </div>
                        <div class="ctrlBasico">
                            <telerik:RadButton ID="btnEliminarEmpleados" OnClick="btnEliminarEmpleados_Click" runat="server" name="btnEliminarEmpleados" AutoPostBack="true" Text="Eliminar" Width="100"></telerik:RadButton>
                        </div>
                    </telerik:RadPane>
                        ...
                        <telerik:RadSlidingZone ID="rszSeleccionEmpleados" runat="server" SlideDirection="Left" ExpandedPaneId="rsSeleccionEmpleados" Width="22px">
                            <telerik:RadSlidingPane ID="rspAyudaSeleccionEmpleados" runat="server" Title="Ayuda" Width="250px" RenderMode="Mobile" Height="100%">
                                <div style="padding: 10px; text-align: justify;">
                                    <p>
                                        Utiliza esta página para seleccionar al grupo que participará en el proceso. Si seleccionas por área, automáticamente todos los empleados que pertenecen a dicha área serán seleccionados; lo mismo sucede si seleccionas por puesto.
                                    <br />
                                        <br />
