<%@ Page Title="" Language="C#" MasterPageFile="~/PDE/ContextPDE.master" AutoEventWireup="true" CodeBehind="VentanaAdministrarTramites.aspx.cs" Inherits="SIGE.WebApp.PDE.VentanaAdministrarTramites" %>

<asp:Content ID="Content1" ContentPlaceHolderID="headContexto" runat="server">
    <script>

        function OnClientLoad(editor) {
            var tree = $find("<%= rlbTramite.ClientID %>");
        ...
        function OnClientNodeDropping(sender, args) {
            var editor = $find("<%=reTramite.ClientID%>");
        ...
        function OnClientNodeDragging(sender, args) {
            var editor = editor = $find("<%=reTramite.ClientID%>");
            var event = args.get_domEvent();
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <div style="height: calc(100% - 60px);">
        ...
        <div style="height: 100%; width: 25%; float: left; ">
            ...
            <div style="width: 100%; height: 100%; float: left;">
                ...
                <telerik:RadListBox runat="server" ID="rlbTramite"
        ...
        <div style="height: 100%; width: 50%; float: left; padding-left: 25px;">
            <div>
                <div style="position: relative; cursor: pointer; overflow: hidden;">
            ...
            <div style="clear: both; height: 10px;"></div>
            <div>
                <telerik:RadTextBox EmptyMessage="Nombre del trámite" ID="txtNombre" Width="100%" Height="30" runat="server"></telerik:RadTextBox>
        ...
        <div style="height: 100%; width: 25%; float: left; padding-left: 50px;">
            <div style="">
                <div style="position: relative; cursor: pointer; overflow: hidden;">
                    <div class="" style="margin-top: 15px; width: 95%">
                        <div style="background-color: #DE1648; width: 100%; text-align: left; color: #FFF;">Selecciona</div>
    ...
    <div class="ctrlBasico">
        <telerik:RadButton CssClass="btnGuardar" ID="btnGuardar" runat="server" Text="Guardar" Width="100" OnClick="btnGuardar_Click"></telerik:RadButton>

    </div>
    <telerik:RadWindowManager ID="rwmEdicionTramites" runat="server" EnableShadow="true">
        <Windows>
            <telerik:RadWindow
                ID="rwTramites"
                runat="server"
