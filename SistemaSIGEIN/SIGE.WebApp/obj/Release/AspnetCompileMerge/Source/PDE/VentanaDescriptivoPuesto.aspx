<%@ Page Title="" Language="C#" MasterPageFile="~/PDE/ContextPDE.master" AutoEventWireup="true" CodeBehind="VentanaDescriptivoPuesto.aspx.cs" Inherits="SIGE.WebApp.PDE.VentanaDescriptivoPuesto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <telerik:RadCodeBlock runat="server" ID="radCodeblock">
        <script type="text/javascript">
            ...
            function CancelarCambios(sender, args) {
                var callBackFunction = Function.createDelegate(sender, function (shouldSubmit) {
                    if (shouldSubmit) {
                        this.click();
                    }
                ...
                var wnd = radconfirm('¿Estas seguro de cancelar los cambios del descriptivo de puesto?, este proceso no podrá revertirse.', callBackFunction, 400, 170, null, "Eliminar Registro");
                args.set_cancel(true);

            }

            function OpenObservacionRechazar() {
                var vURL = "VentanaRechazoDeModificacionInformacion.aspx?IdCambio=" + '<%= vIdCambio %>' + "&ClAutorizacion=Rechazada" + "&IdPuesto=" + '<%= vIdDescriptivo %>';
            var vTitulo = "Rechazar modificación";
        ...
        <telerik:RadSplitter ID="splEmpleados" runat="server" Width="100%" Height="100%" BorderSize="0">
            <telerik:RadPane ID="rpnGridEmpleados" runat="server">
                <div id="lblRechazo" runat="server" style="padding-left: 10px; height: 20px; Width: 80%; overflow: auto; background-color: skyblue">
                    <label id="Label3" runat="server" class="Notificacion"></label>
                </div>
                <div style="clear: both; height: 10px;"></div>
                <div id="principal" style="background: #A4A4A4; opacity: 0.5; height: 99%; width: 99%;" class="principal" runat="server" visible="true">
                </div>
                <div id="copia" style="background: white; border-radius: 5px; border-width: 10px; height: 170px; width: 400px;" class="copia" runat="server" visible="true">
                    <div class="ctrlBasico" style="width: 95%; padding-top: 20px; text-align: center;">
                        <div style="float: left; padding: 10px;">
                            <label class="labelTitulo" style="width: 100%">Copiar información original del descriptivo de puesto. </label>
                        </div>
                    </div>

                    <div style="padding-left: 2%">
                        <div class="ctrlBasico">
                            <telerik:RadButton runat="server" ID="btnAceptar" Text="Aceptar" Width="100" OnClick="btnAceptar_Click" AutoPostBack="true"></telerik:RadButton>
                        </div>
                        <div class="ctrlBasico">
                            <telerik:RadButton ID="btnCancelarCopia" runat="server" Text="Cancelar" Width="100" OnClientClicking="closeWindow"></telerik:RadButton>
                        </div>
                    </div>
                </div>
                ...
                <div style="height: calc(100% - 165px); overflow: auto; padding: 10px 0px 10px 0px;">
                    <telerik:RadMultiPage ID="mpgdescriptivo" runat="server" SelectedIndex="0" Height="100%" Width="100%">
                        ...
                        <telerik:RadPageView ID="pvwperfilIngreso" runat="server">
                                ...
                                <div class="BorderRadioComponenteHTML" style="width: 500px; float: left;">
                                    <div class="divBarraTitulo">
                                        ...
                                        <div style="text-align: right;">
                                            <div class="divControlDerecha">
                                                <telerik:RadComboBox runat="server" ID="radcmbPostgrados" MarkFirstMatch="true" EmptyMessage="Selecciona" Width="300" MaxHeight="200" DropDownWidth="450"></telerik:RadComboBox>
                            ...
                            <div class="ctrlBasico">
                                <div class="BorderRadioComponenteHTML" style="width: 500px; float: left;">
                                    <div class="divBarraTitulo">
                                        ...
                                        <div style="text-align: right;">
                                            <div class="divControlDerecha">
                                                <telerik:RadComboBox runat="server" ID="cmbCarreraProf" MarkFirstMatch="true" EmptyMessage="Selecciona" Width="300" MaxHeight="200" DropDownWidth="450"></telerik:RadComboBox>
                            ...
                            <div class="ctrlBasico">
                                <div class="BorderRadioComponenteHTML" style="width: 500px; float: left;">
                                    <div class="divBarraTitulo">
                                        ...
                                        <div style="text-align: right;">
                                            <div class="divControlDerecha">
                                                <telerik:RadComboBox runat="server" ID="cmbCarrTec" MarkFirstMatch="true" EmptyMessage="Selecciona" Width="300" MaxHeight="200" DropDownWidth="450"></telerik:RadComboBox>
                            ...
                            <div class="ctrlBasico">
                                <div class="BorderRadioComponenteHTML" style="width: 520px; float: left;">
                                    ...
                                    <div style="padding: 5px">
                                        <div class="ctrlBasico" style="text-align: right; width: 100%;">
                                            <telerik:RadListBox runat="server" ID="lstCompetenciasEspecificas" Width="100%" AllowDelete="true" ButtonSettings-AreaWidth="35px"></telerik:RadListBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="ctrlBasico">
                                <div class="BorderRadioComponenteHTML" style="width: 700px; float: left;">
                                            ...
                                            <div id="divContenido" runat="server" style="display: none;">
                                                <div class="ctrlBasico" style="padding-top: 10px; padding-right: 19px; padding-left: 10px;">
                                                    <div>
                                                        ...
                                                        <div class="divControlDerecha">
                                                            <telerik:RadComboBox runat="server" ID="cmbExperiencias" MarkFirstMatch="true" EmptyMessage="Selecciona" Width="200" DropDownWidth="450" MaxHeight="250"></telerik:RadComboBox>
                                                        </div>
                                                    </div>
                                    ...
                                    <div style="padding: 5px">
                                        <div class="ctrlBasico" style="text-align: right; width: 100%;">
                                            <telerik:RadListBox runat="server" ID="lstExperiencia" Width="100%" AllowDelete="true" ButtonSettings-AreaWidth="35px">
                                                <HeaderTemplate>
                        ...
                        <telerik:RadPageView ID="pvwOroganigrama" runat="server">
                            ...
                            <div class="ctrlBasico">
                                <div class="BorderRadioComponenteHTML" style="width: 550px; float: left;">
                                    <div class="divBarraTitulo">
                                        ...
                                        <div style="text-align: right;">
                                            <div class="divControlDerecha">
                                                <telerik:RadComboBox runat="server" ID="cmbPuestosSubordinado" MarkFirstMatch="true" EmptyMessage="Selecciona" Width="200" MaxHeight="200" DropDownWidth="450" ToolTip="Aquí debes especificar los puestos que reportan directamente a este puesto."></telerik:RadComboBox>
                            ...
                            <div class="ctrlBasico">
                                ...
                                <div class="divControlIzquierda" style="line-height: 33px; width: 80px">
                                    <telerik:RadButton ID="btnLinea" runat="server" ToggleType="Radio" ButtonType="ToggleButton" AutoPostBack="false" GroupName="RadiosPosicion" ToolTip="Debes seleccionar esta opción si la posición en el organigrama de este puesto es de línea. Ejemplo: Coordinador de Nómina, Gerente de Producción, Operario Especializado, etc.">
                                        <ToggleStates>
                        ...
                        <telerik:RadPageView ID="pvwResponsaFuncionalidadesGener" runat="server">
                            ...
                            <div>
                                <telerik:RadEditor NewLineMode="Br" Height="150px" Width="99%" EditModes="Design" ID="radEditorResponsable" runat="server" ToolbarMode="Default" ToolsFile="~/Assets/AdvancedTools.xml" ToolTip="Aquí debes especificar la razón de ser del puesto de manera genérica. Ejemplo: puesto de Gerente de Producción: es responsable de administrar los programas de producción garantizando que el producto terminado cumpla con las especificaciones del cliente y logrando la satisfacción laboral de su equipo de trabajo, respetando y haciendo respetar las políticas, valores y procedimientos de la empresa."></telerik:RadEditor>
                            </div>
                            <div>
                        ...
                        <telerik:RadPageView ID="pvwFuncionesGenericas" runat="server">
                            ...
                            <div style="height: calc(100% - 80px);">
                                ...
                                <telerik:RadGrid ID="grdFuncionesGenericas" runat="server" AutoGenerateColumns="false" Height="100%"
                                    OnNeedDataSource="grdFuncionesGenericas_NeedDataSource" HeaderStyle-Font-Bold="true"
                                    OnItemDataBound="grdFuncionesGenericas_ItemDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridTemplateColumn HeaderText="Detalle" UniqueName="Funciones">
                                                <ItemTemplate>
                                                    ...
                                                    <telerik:RadGrid ID="grdCompetencias" runat="server" HeaderStyle-Font-Bold="true" AutoGenerateColumns="false">
                                                        <MasterTableView>
                                                            <Columns>
                ...
                <div class="divControlDerecha">
                    <div class="ctrlBasico">
                        <telerik:RadButton runat="server" ID="btnAutorizar" Text="Autorizar" AutoPostBack="true" OnClick="btnAutorizar_Click" />
                    </div>
                    <div class="ctrlBasico">
                        <telerik:RadButton runat="server" ID="btnRechazar" Text="Rechazar" AutoPostBack="false" OnClientClicked="OpenObservacionRechazar" />
                    </div>
                    <div class="ctrlBasico">
                        <telerik:RadButton runat="server" ID="btnCancelar" Text="Cancelar cambios" OnClick="btnCancelar_Click1" OnClientClicking="CancelarCambios" />
                    </div>
                    <div class="ctrlBasico">
                        <telerik:RadButton runat="server" ID="btnGuardar" Text="Guardar" AutoPostBack="true" OnClick="btnGuardar_Click" />
                    </div>
                    <div class="ctrlBasico">
                        <telerik:RadButton runat="server" ID="btnTerminar" Text="Terminar" AutoPostBack="true" OnClick="btnTerminar_Click" />
                    </div>
    ...
    <telerik:RadWindow ID="winFuncionesGenericas" runat="server" Width="1000" Height="580" Behaviors="Close" Title="Función genérica" VisibleStatusbar="false" Modal="true" OnClientShow="fixEditor" VisibleOnPageLoad="false" DestroyOnClose="true">
        <ContentTemplate>
            <div style="width: calc(100% - 2px); padding: 10px; height: 100%">
                        ...
                        <telerik:RadMultiPage ID="rmpFuncionGenerica" runat="server" SelectedIndex="0" Height="100%">
                            <telerik:RadPageView ID="rpvFuncionGenericaDefinicion" runat="server">
                                <div style="padding-bottom: 10px;">
                                    ...
                                    <telerik:RadTextBox ID="txtNbFuncion" runat="server" Width="600"></telerik:RadTextBox>
                                </div>
                                <div style="padding-bottom: 10px;">
                                    <label class="labelTitulo" name="lblDetalleFuncion">Detallar las funciones específicas</label>
                                    <telerik:RadEditor NewLineMode="Br" Height="125px" Width="100%" ToolsWidth="310px" EditModes="Design" ID="txtDetalleFuncion" runat="server" ToolbarMode="Default" ToolsFile="~/Assets/AdvancedTools.xml"></telerik:RadEditor>
                                </div>
                                <div>
                            ...
                            <telerik:RadPageView ID="rpvFuncionGenericaCompetencias" runat="server">
                                ...
                                <div id="ctrlAgregarCompetenciaEspecifica" style="display: none; padding: 10px; border: 1px solid lightgray; border-radius: 5px;">
                                    <div class="ctrlBasico">
                                        <label id="lblNbCompetenciaABC" name="lblNbCompetenciaABC">Competencia específica:</label>
                                        <telerik:RadComboBox ID="cmbCompetenciaEspecifica" Width="350" runat="server" OnSelectedIndexChanged="cmbCompetenciaEspecifica_SelectedIndexChanged" EmptyMessage="Seleccione..." AutoPostBack="true"></telerik:RadComboBox>
                                    </div>
                                    <div class="ctrlBasico">
                                        <telerik:RadGrid ID="grdNivelCompetenciaEspecifica" runat="server" OnPreRender="grdNivelCompetenciaEspecifica_PreRender">
                                ...
                                <div id="ctrlAgregarIndicadorDesempeno" style="display: none; padding: 10px; border: 1px solid lightgray; border-radius: 5px;">
                                    <div class="ctrlBasico">
                                        <label id="lblNbIndicadorABC" name="lblNbIndicadorABC">Indicadores de desepempeño (evidencias):</label>
                                        <telerik:RadTextBox ID="txtIndicadorDesempeno" runat="server" Width="400"></telerik:RadTextBox>
                                    </div>
                                    <div style="clear: both;"></div>
                                    <div class="ctrlBasico">
                                ...
                                <div style="height: calc(100% - 100px);">
                                    <telerik:RadGrid ID="grdFuncionCompetencias" runat="server" AutoGenerateColumns="false" Height="300" ShowHeader="true" EnableHierarchyExpandAll="true"
                                        ...
                                        OnItemCommand="grdFuncionCompetencias_ItemCommand">
                                        <ClientSettings>
                                            <Scrolling UseStaticHeaders="true" AllowScroll="true" />
                                            <Selecting AllowRowSelect="true" />
                                        </ClientSettings>
                                ...
                                <div class="ctrlBasico">
                                    <telerik:RadButton ID="btnAgregarIndicador" runat="server" Text="Agregar indicador" AutoPostBack="false" OnClientClicked="ShowIndicadorDesempenoInsertForm"></telerik:RadButton>
                                </div>
                                <div class="ctrlBasico">
                ...
                <div class="divControlDerecha">
                    ...
                    <div class="ctrlBasico">
                        <telerik:RadButton ID="btnCancelarGuardarFuncionGenerica" runat="server" Text="Cancelar"></telerik:RadButton>
                    </div>
                    <div style="clear: both;"></div>
                </div>
            </div>
