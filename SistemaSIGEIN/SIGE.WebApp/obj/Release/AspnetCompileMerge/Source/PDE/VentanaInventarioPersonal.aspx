<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/PDE/ContextPDE.master" CodeBehind="VentanaInventarioPersonal.aspx.cs" Inherits="SIGE.WebApp.PDE.VentanaInventarioPersonal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <div style="height: calc(100% - 50px); width: 100%">
        <telerik:RadSplitter ID="rsSolicitud" Width="100%" Height="100%" BorderSize="0" runat="server">
            <telerik:RadPane ID="rpSolicitud" runat="server" Width="100%">
                ...
                <div style="height: calc(100% - 45px);">
                    <telerik:RadMultiPage ID="mpgPlantilla" runat="server" SelectedIndex="0" Height="100%" Width="100%" ScrollBars="Auto">
                        <telerik:RadPageView ID="pvwPersonal" runat="server" Width="100%" Height="100%">
