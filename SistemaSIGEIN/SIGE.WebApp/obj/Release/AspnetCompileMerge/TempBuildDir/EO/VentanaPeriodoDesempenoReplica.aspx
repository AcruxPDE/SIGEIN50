...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <telerik:RadAjaxManager ID="ramReplicaPeriodo" runat="server" DefaultLoadingPanelID="ralpReplicarPeriodo">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="btnReplicarPeriodo">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="grdPeriodosReplica" UpdatePanelHeight="100%" />
                    <telerik:AjaxUpdatedControl ControlID="feInicio" UpdatePanelRenderMode="Inline" />
                    <telerik:AjaxUpdatedControl ControlID="feFin" UpdatePanelRenderMode="Inline" />
                </UpdatedControls>
            </telerik:AjaxSetting>
        </AjaxSettings>
    ...
    <div class="ctrlBasico" style="padding-left: 5px;">
        <br />
        <telerik:RadButton ID="btnReplicarPeriodo" runat="server" Width="200px" Text="Replicar periodo" AutoPostBack="true" OnClick="btnReplicarPeriodo_Click"></telerik:RadButton>
    </div>
    <div style="clear: both; height: 10px;"></div>
    <div class="ctrlBasico">
        <telerik:RadGrid ID="grdPeriodosReplica" ShowHeader="true" runat="server" AllowPaging="false"
            AllowSorting="true" Width="100%" Height="300" HeaderStyle-Font-Bold="true"
            ...
            <MasterTableView ClientDataKeyNames="ID_PERIODO,ID_PERIODO_REPLICA" DataKeyNames="ID_PERIODO,ID_PERIODO_REPLICA" ShowHeadersWhenNoRecords="true" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" HeaderText="Descripciòn" DataField="DS_PERIODO" UniqueName="DS_PERIODO" HeaderStyle-Width="250" FilterControlWidth="240" HeaderStyle-Font-Bold="true"></telerik:GridBoundColumn>
