...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPruebas" runat="server">
            ...
            window.onload = function (sender, args) {
                ...
                if ('<%=this.vTipoRevision%>' != "REV" && '<%=this.vTipoRevision%>' != "EDIT") {
                    var callBackFunction = Function.createDelegate(sender, function (shouldSubmit) {
                        ...
                        radconfirm(JustificarTexto(text), callBackFunction, 450, 450, null, "Aptitud mental I");
                }
                else {
    ...
    <div class="divControlDerecha">
        ...
        <div class="ctrlBasico">
            ...
            <telerik:RadButton ID="RadButton1" runat="server" OnClientClicked="llamaAjaxRequest" Text="Siguiente" AutoPostBack="false"></telerik:RadButton>
