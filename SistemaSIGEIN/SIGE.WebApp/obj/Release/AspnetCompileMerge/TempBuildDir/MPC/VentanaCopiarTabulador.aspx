...
<div class="ctrlBasico">
        <div class="divControlIzquierda" style="width:150px">
            <label id="lbNombre" 
                name="lbNombre" 
                runat="server">Nombre de tabulador:</label>
        </div>
    <div class="divControlDerecha">
    ...
    <div style="clear:both;"> </div>
     <div class="ctrlBasico">
         ...
         <div class="divControlDerecha">
                 <telerik:RadDatePicker ID="rdpCreacion"  Enabled="true" runat="server"  Width="140px" >
   ...
   <div class="ctrlBasico">
       ...
       <div class="divControlDerecha">
             <telerik:RadDatePicker ID="rdpVigencia"  runat="server" Width="140px" >
