                            ...
                            <telerik:RadGrid ID="grdCompensacion" runat="server" Height="300px" Width="1000px" AutoGenerateColumns="false" EnableHeaderContextMenu="true" ShowGroupPanel="false"
                                ...
                                <MasterTableView ClientDataKeyNames="ID_BITACORA_SUELDO" EnableColumnsViewState="false" DataKeyNames="ID_BITACORA_SUELDO" AllowPaging="false" AllowFilteringByColumn="false" ShowHeadersWhenNoRecords="true" EnableHeaderContextFilterMenu="true"
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" HeaderStyle-Width="100" FilterControlWidth="25" HeaderText="Anterior" DataField="NB_ANTERIOR" UniqueName="NB_ANTERIOR">
                                            <ItemStyle HorizontalAlign="Right" />
                                        </telerik:GridBoundColumn>
                                        <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" HeaderStyle-Width="100" FilterControlWidth="25" HeaderText="Actual" DataField="NB_ACTUAL" UniqueName="NB_ACTUAL">
                                            <ItemStyle HorizontalAlign="Right" />
                                        </telerik:GridBoundColumn>
                                    </Columns>
                                </MasterTableView>
