    ...
    <script type="text/javascript">
        ...
        function OpenReporteIndividualWindow() {
            ...
            if (vIdPeriodo != null & vIdEvaluado != 0) {
                OpenSelectionWindow("ReporteIndividual.aspx?IdPeriodo=" + vIdPeriodo + "&IdEvaluado=" + vIdEvaluado + "&IdReporteIndividual=" + vIdReporteIndividual + "&ClTipoReporte=INDIVIADUAL", "rwReporte", "Reporte General Individual");
            } else {
        ...
        function OpenPeriodoSelectionWindow() {
            ...
            if (vIdEmpleado != 0) {
                OpenSelectionWindow("../Comunes/SeleccionPeriodo.aspx?m=FORMACION&IdEmpleado=" + vIdEmpleado, "winSeleccion", "Selección de periodo")
            }
            else {
   ...
   <%-- <div class="ctrlBasico">
    ...
    <telerik:RadTabStrip runat="server" ID="rtsIndividual" MultiPageID="rmpIndividual" SelectedIndex="0" Width="100%">
        <Tabs>
            ...
            <telerik:RadTab runat="server" Text="Seleccionar periodos"></telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>
    ...
    <div class="divControlDerecha">
        <telerik:RadButton runat="server" ID="btnIndividual" Text="Reporte Individual" AutoPostBack="false" OnClientClicked="OpenReporteIndividualWindow"></telerik:RadButton>
    </div>
