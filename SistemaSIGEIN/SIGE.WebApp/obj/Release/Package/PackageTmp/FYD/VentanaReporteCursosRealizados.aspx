...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContexto" runat="server">
    ...
    <telerik:RadGrid runat="server" ID="rgCursos" AllowSorting="true" AutoGenerateColumns="false" HeaderStyle-Font-Bold="true" ShowFooter="true" OnNeedDataSource="rgCursos_NeedDataSource" AllowFilteringByColumn="true" Width="100%" Height="98%">
        <ClientSettings>
        ...
        <MasterTableView DataKeyNames="ID_EVENTO" ShowHeadersWhenNoRecords="true">
            <Columns>
                ...
                <telerik:GridBoundColumn CurrentFilterFunction="Contains" AutoPostBackOnFilter="true"  UniqueName="NB_INSTRUCTOR" DataField="NB_INSTRUCTOR" FooterText="Totales:" FooterStyle-Font-Bold="true" FooterStyle-HorizontalAlign="Right" HeaderText="Instructor" FilterControlWidth="130" HeaderStyle-Width="200"></telerik:GridBoundColumn>
                  <telerik:GridBoundColumn CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="true"   UniqueName="MN_COSTO_DIRECTO" DataField="MN_COSTO_DIRECTO" FilterControlWidth="40" HeaderStyle-Width="100" HeaderText="Costo directo" FooterStyle-HorizontalAlign="Right" Aggregate="Sum" FooterAggregateFormatString="${0:N2}">
                    <ItemStyle HorizontalAlign="Right" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn CurrentFilterFunction="EqualTo" AutoPostBackOnFilter="true"   UniqueName="MN_COSTO_INDIRECTO" DataField="MN_COSTO_INDIRECTO" FilterControlWidth="40" HeaderStyle-Width="100" HeaderText="Costo indirecto" FooterStyle-HorizontalAlign="Right" Aggregate="Sum" FooterAggregateFormatString="${0:N2}">
                    <ItemStyle HorizontalAlign="Right" />
                </telerik:GridBoundColumn>
