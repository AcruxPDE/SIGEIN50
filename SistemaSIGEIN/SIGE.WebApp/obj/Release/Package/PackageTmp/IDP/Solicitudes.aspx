<%@ Page Title="" Language="C#" MasterPageFile="~/IDP/MenuIDP.master" AutoEventWireup="true" CodeBehind="Solicitudes.aspx.cs" Inherits="SIGE.WebApp.IDP.Solicitudes" %>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock2" runat="server">
        ...
        <script id="MyScript" type="text/javascript">
            ...
            function OpenContratarWindow(pIdSolicitud) {
                var vURL = "/IDP/VentanaContratarCandidato.aspx";
                ...
                <telerik:RadGrid
                    ...
                    <MasterTableView ClientDataKeyNames="ID_SOLICITUD,ID_CANDIDATO,ID_BATERIA,CL_TOKEN,K_SOLICITUD_CL_SOLICITUD_ESTATUS,ID_REQUISICION" EnableColumnsViewState="false" DataKeyNames="ID_SOLICITUD,ID_BATERIA" AllowPaging="true" AllowFilteringByColumn="true" ShowHeadersWhenNoRecords="true" EnableHeaderContextFilterMenu="true">
                        <Columns>
                            ...
                            <telerik:GridBoundColumn AutoPostBackOnFilter="true" CurrentFilterFunction="Contains" Visible="true" Display="true" HeaderStyle-Width="100" FilterControlWidth="60" HeaderText="No. de empleado" DataField="M_EMPLEADO_CL_EMPLEADO" UniqueName="M_EMPLEADO_CL_EMPLEADO"></telerik:GridBoundColumn>
