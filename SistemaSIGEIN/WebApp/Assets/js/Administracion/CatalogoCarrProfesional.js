...
app.controller('C_CARRERA_PROFESIONALController', function ($scope, $http, $modal,$rootScope) {
    ...
    $scope.ObtieneDatos_C_NIVEL_ESCOLARIDAD = function () {
        $scope.C_NIVEL_ESCOLARIDAD("PROFESIONAL", function (Objeto) {
    ...
    $scope.titulo = C_CARRERA_PROFESIONAL.TITULO_PANTALLA;
    ...
    $rootScope.atributos =
        {
            id: 'Grid_CatalogoEscolaridad_Profesional',
            titulo: $scope.titulo,
            grid: "#Grid_CatalogoEscolaridad_Profesional",
            getgrid: "Get_C_ESCOLARIDAD",
            deletegrid: "Delete_C_ESCOLARIDAD",
            entidad: 'C_CARRERA_PROFESIONAL',
            templateUrl: 'op_CatalogoEscolaridad_Prof.html',
            controller: 'Modal_CatalogoEscolaridad_Prof',
    ...
    $rootScope.configuracion = {
        titulo: $scope.titulo,
        gridd: "#Grid_CatalogoEscolaridad_Profesional",
        campos: campos_mostrar.array,
        xml: "<root>" +
                  "<row1>" +
...
app.controller('Modal_CatalogoEscolaridad_Prof', function ($scope, $modalInstance, $http, OBJETO,$rootScope) {
            ...
            if (Objeto.length != 0) {
                ...
                .then(function (response) {
                    if (response.data != true) {
                        ...
                        $rootScope.Llena_Grid_Dinamico();// se manda a refrescar e "" grid dinamico
                        if ($scope.ID_ESCOLARIDAD == undefined) {
                            LimpiarFormulario("newForm");
                        }
                        BootstrapDialog.show({
