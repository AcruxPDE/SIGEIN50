...
app.controller('C_CARRERA_TECNICAController', function ($scope, $http, $modal,$rootScope) {
    ...
    $scope.ObtieneDatos_C_NIVEL_ESCOLARIDAD = function () {
        $scope.C_NIVEL_ESCOLARIDAD("TECNICO", function (Objeto) {
    ...
    var campos_mostrar = { "array": ["CL_NIVEL_ESCOLARIDAD", "NB_ESCOLARIDAD", "DS_ESCOLARIDAD"] };
    ...
    $rootScope.atributos =
        {
            id: 'Grid_CatalogoEscolaridad_Tecnica',
            titulo: $scope.titulo,
            grid: "#Grid_CatalogoEscolaridad_Tecnica",
            getgrid: "Get_C_ESCOLARIDAD",
            deletegrid: "Delete_C_ESCOLARIDAD",
            entidad: 'C_CARRERA_POSGRADO',
            templateUrl: 'op_Escolaridad_Tec.html',
            controller: 'Modal_CatalogoEscolaridad_T',
            programa: 'CatalogoCatalogoEscolaridad.html',
            campos: campos_mostrar.array,
            filtro: filtros,
            ObjInsUpd: INSERT_UPDATE
             , btn_adicional: 'hidden' //se agrego para el control de botones adicionales
        };

    $rootScope.configuracion = {
        titulo: C_CARRERA_TECNICA.TITULO_PANTALLA,
        grid: "#Grid_CatalogoEscolaridad_Tecnica",
        campos: campos_mostrar.array,
        xml: "<root>" +
                  "<row1>" +
...
app.controller('Modal_CatalogoEscolaridad_T', function ($scope, $modalInstance, $http, OBJETO,$rootScope) {
    ...
    $scope.lbl_CL_NIVEL_ESCOLARIDAD = C_CARRERA_TECNICA.CL_NIVEL_ESCOLARIDAD;
    $scope.ph_CL_NIVEL_ESCOLARIDAD = C_CARRERA_TECNICA.CL_NIVEL_ESCOLARIDAD_ph;
    $scope.lbl_DS_ESCOLARIDAD = C_CARRERA_TECNICA.DS_ESCOLARIDAD;
    $scope.ph_DS_ESCOLARIDAD = C_CARRERA_TECNICA.DS_ESCOLARIDAD_ph;
    $scope.lbl_ID_ESCOLARIDAD = C_CARRERA_TECNICA.ID_ESCOLARIDAD;
    $scope.ph_ID_ESCOLARIDAD = C_CARRERA_TECNICA.ID_ESCOLARIDAD_ph;
    $scope.lbl_NB_ESCOLARIDAD = C_CARRERA_TECNICA.NB_ESCOLARIDAD;
    $scope.ph_NB_ESCOLARIDAD = C_CARRERA_TECNICA.NB_ESCOLARIDAD_ph;
    $scope.lblActivo = C_CARRERA_TECNICA.FG_ACTIVO;
    ...
    $scope.cancel = function () {
      //  $("#Grid_CatalogoEscolaridad").data("kendoGrid").dataSource.read();
