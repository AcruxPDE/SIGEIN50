...
app.controller('DESCRIPTIVOPUESTOSController', function ($scope, $http, $modal, fileUpload,$rootScope) {
    ...
    $scope.TAB1 = "Perfil de ingreso";
    $scope.TAB2 = "Organigrama";
    $scope.TAB3 = "Responsabilidades y funciones genéricas";
    $scope.TAB4 = "Competencias genericas";
    $scope.TAB5 = "Campos extra";
    $scope.TAB6 = "Vista Previa";
    $scope.GENERALES = "Generales";
    ...
    $scope.NB_PUESTO = "Prueba";//$rootScope.Nb_puesto;
    $scope.CL_PUESTO = "Clave";//$rootScope.Clavep;
   // $scope.Id_puesto = $scope.ID_PUESTO;
    ...
    $(document).ready(function () {
        $("#tbsDescriptivoPuestos").on("keydown", function (e) {
    ...
    $scope.disabled_puesto = function () { //en caso de que le den click en aceptar generara lo siguiente  

        if (contador == 0) {


            $('#txt_CL_PUESTO').attr('disabled', 'disabled'); //Disable
            // $('#fieldId').removeAttr('disabled');
            contador = 1;
        }
        else {
            $('#txt_CL_PUESTO').removeAttr('disabled');
            contador = 0;
        }
    ...
    $scope.disabled_puesto2 = function () { //en caso de que le den click en aceptar generara lo siguiente  

        if (contador == 0) {


            $('#txt_NB_PUESTO').attr('disabled', 'disabled'); //Disable
            // $('#fieldId').removeAttr('disabled');
            contador = 1;
        }
        else {
            $('#txt_NB_PUESTO').removeAttr('disabled');
            contador = 0;
        }
